...
<title>BzPayroll - Edit W-9 Form</title>
									...
									<td valign="top"
										...
										<div class="main-container">
											<div class="row">
												<!-- Form Column -->
												<div class="col-md-12">
													<form action="/update-w9form" method="post" name="w2form">
    									...
    									<td valign="top"
    										...
    										<div class="main-container">
                                            											<div class="row">
                                            												<!-- Form Column -->
                                            												<div class="col-md-12">
                                            													<form action="save-w9form" method="post" name="w9form">

                                            														<!-- Panel Start -->
                                            														<div class="panel">
                                            															<div class="panel-header"
                                                                                                            																style="background-color: #D3D3D3; text-align: center; text-align:center;">
                                            															...
                                            															<div class="panel-body">
                                            																...
                                            																<!-- Form Layout -->
                                            																<div class="form-layout">
                                            																	<table class="table table-bordered boarder" style="margin: 0;">
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="employeeIndexId" value="${bcpW9Form.employeeIndexId}" />

                                                        <input type="text" name="nameOfEntity" value="${bcpW9Form.nameOfEntity}" class="form-control digital-input" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="6" style="font-size: 10px;"><b>2</b> Business name/disregarded entity name, if different from above

                                                        <input type="text" name="businessName" value="${bcpW9Form.businessName}" class="form-control digital-input" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="5" style="font-size: 10px;">
                                                        <div><b>3a</b> Check the appropriate box for federal tax classification of the entity/individual whose name is entered on line 1. Check
                                                                only one of the following seven boxes</div>
                                                        <label><input type="checkbox" name="individual" value="Yes" ${bcpW9Form.individual == 'Yes' ? 'checked' : ''}/> Individual/sole proprietor</label>
                                                        <label><input type="checkbox" name="cCorporation" value="Yes" ${bcpW9Form.cCorporation == 'Yes' ? 'checked' : ''}/> C corporation</label>
                                                        <label><input type="checkbox" name="sCorporation" value="Yes" ${bcpW9Form.sCorporation == 'Yes' ? 'checked' : ''}/> S corporation</label>
                                                        <label><input type="checkbox" name="partnership" value="Yes" ${bcpW9Form.partnership == 'Yes' ? 'checked' : ''}/> Partnership</label>
                                                        <label><input type="checkbox" name="trustOrEstate" value="Yes" ${bcpW9Form.trustOrEstate == 'Yes' ? 'checked' : ''}/> Trust/estate</label>
                                                        <label>
                                                            <input type="checkbox" name="llc" value="Yes" ${bcpW9Form.llc == 'Yes' ? 'checked' : ''}/>
                                                            LLC. Enter the tax classification (C = C corporation, S = S corporation, P = Partnership) . . . . <input type="text" name="llcType" value="${bcpW9Form.llcType}" style="width: 50px;" /></label><br>
                                                       ...
                                                       box for the tax classification of its owner
                                                            ...
                                                            <br><label><input type="checkbox" name="other" value="Yes" ${bcpW9Form.other == 'Yes' ? 'checked' : ''}/>
                                                            Other (see instructions)</label>
                                                            <input type="text" name="otherText" value="${bcpW9Form.otherText}" style="width: 80%;" />
                                                    ...
                                                    <td rowspan="2" style="font-size: 10px;"><b>4</b> Exemptions (codes apply only to
                                                                    ...
                                                                    <input type="text" name="exemptCode" value="${bcpW9Form.exemptCode}" class="form-control digital-input" style="width:25%" />
                                                                    Exemption from Foreign Account Tax
                                                                    Compliance Act (FATCA) reporting
                                                                     code (if any)
                                                                    <input type="text" name="fatcaCode" value="${bcpW9Form.fatcaCode}" class="form-control digital-input" /><br>
                                                    ...
                                                    <td colspan="5" style="font-size: 10px;">
                                                        <label>
                                                           <b>3b</b> If on line 3a you checked “Partnership” or “Trust/estate,” or checked “LLC” and entered “P” as its tax classification,<br>
                                                            ...
                                                            <input type="checkbox" name="hasForeignOwners" value="Yes" ${bcpW9Form.hasForeignOwners == 'Yes' ? 'checked' : ''}/>
                                                        </label>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="font-size: 10px; width:60%;" colspan="3"><b>5</b> Address (number, street, and apt. or suite no.). See instructions
                                                        ...
                                                        <input type="text" name="address" value="${bcpW9Form.address}" class="form-control digital-input" />
                                                    </td>

                                                   <td style="font-size: 10px;" colspan="3" rowspan="2" >
                                                      Requester’s name and address (optional)
                                                     <textarea name="requesterInfo" class="form-control digital-input" style="width: 100%; height: 4.6em;" >${bcpW9Form.requesterInfo}</textarea>
                                                   </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 10px;" colspan="3"><b>6</b> City, state, and ZIP code

                                                        <input type="text" name="cityStateZip" value="${bcpW9Form.cityStateZip}" class="form-control digital-input" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 10px;" colspan="6"><b>7</b> List account number(s) here (optional)

                                                        <input type="text" name="accountNumbers" value="${bcpW9Form.accountNumbers}" class="form-control digital-input" />
                                                    </td>
                                                </tr>
                                                ...
                                                Number To Give the Requester for guidelines on whose number to enter.
                                                    ...
                                                    <td style="font-size: 10px; text-align:center;" colspan="2">Social security number<br>
                                                        ...
                                                        <input type="text" name="ssn1" value="${bcpW9Form.ssn1}" maxlength="3" style="width: 55px;" class="digital-input" /> -
                                                        <input type="text" name="ssn2" value="${bcpW9Form.ssn2}" maxlength="2" style="width: 30px;" class="digital-input" /> -
                                                        <input type="text" name="ssn3" value="${bcpW9Form.ssn3}" maxlength="4" style="width: 55px;" class="digital-input" />

                                                   <br><b>or</b> <br>Employer identification number<br>

                                                        <input type="text" name="ein1" value="${bcpW9Form.ein1}" maxlength="2" style="width: 30px;" class="digital-input" /> -
                                                        <input type="text" name="ein2" value="${bcpW9Form.ein2}" maxlength="7" style="width: 110px;" class="digital-input" />
                                                    </td>
                                                </tr>
