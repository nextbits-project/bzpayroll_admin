...
<div style="width:100%" class="header-section">
	<div class="bzclogo" style="float:left;">
		<a href="${pageContext.request.contextPath}/Dashboard?tabid=Dashboard">
			<img src="${pageContext.request.contextPath}/images/bzcweb.jpg"
			     width="289" height="75" style="margin-left: 30px;" alt="bzcomposer"/>
		</a>
	</div>
	<br>
	<div style="float:right; padding-right: 51px; padding-top: 10px;">
		<div style="color: #05A9C5; font-weight: bold;">
			...
			<div class="horizontal">
				...
				<spring:message code="BzComposer.register.with" />
				<%= (String)session.getAttribute("membershipLevel") %>
				<spring:message code="BzComposer.register.membershiplabel" />
			</div>
