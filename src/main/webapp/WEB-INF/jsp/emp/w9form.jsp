...
<form action="save-w9form" method="post" name="w9form">
							<div style="display: flex; width: 100%; margin: 0; border-spacing: 0; border-collapse: collapse;">
								<table cellspacing="0"
									style="border: 0; width: 100%; margin: 0; padding: 0; border-collapse: collapse;"
                                                                ...
                                                                <table class="table table-bordered boarder" style="margin-bottom:-15px;">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td colspan="5" style="font-size: 10px;">
                                                                                                                        ...
                                                                                                                        <label><input type="checkbox" name="individual" value="Yes" ${bcpW9Form.individual eq 'Yes' ? 'checked' : ''} /> Individual/sole proprietor</label>
                                                                                                                        <label><input type="checkbox" name="cCorporation" value="Yes" ${bcpW9Form.cCorporation eq 'Yes' ? 'checked' : ''} /> C corporation</label>
                                                                                                                        <label><input type="checkbox" name="sCorporation" value="Yes" ${bcpW9Form.sCorporation eq 'Yes' ? 'checked' : ''} /> S corporation</label>
                                                                                                                        <label><input type="checkbox" name="partnership" value="Yes" ${bcpW9Form.partnership eq 'Yes' ? 'checked' : ''} /> Partnership</label>
                                                                                                                        <label><input type="checkbox" name="trustOrEstate" value="Yes" ${bcpW9Form.trustOrEstate eq 'Yes' ? 'checked' : ''} /> Trust/estate</label>
                                                                                                                        <label>
                                                                                                                            <input type="checkbox" name="llc" value="Yes" ${bcpW9Form.llc eq 'Yes' ? 'checked' : ''} />
                                                                                                                       ...
                                                                                                                       box for the tax classification of its owner
                                                                                                                            ...
                                                                                                                            <br><label><input type="checkbox" name="other" value="Yes" ${bcpW9Form.other eq 'Yes' ? 'checked' : ''} />
                                                                                                                            Other (see instructions)</label>
                                                                                                                            <input type="text" name="otherText" value="${bcpW9Form.otherText}" style="width: 80%;" class="digital-input" />
                                                                                                                    ...
                                                                                                                    <td rowspan="2" style="font-size: 10px;"><b>4</b> Exemptions (codes apply only to
                                                                                                                                    ...
                                                                                                                                    <input type="text" name="exemptCode" value="${bcpW9Form.exemptCode}" class="form-control" style="width:25%" />
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td colspan="5" style="font-size: 10px;">
                                                                                                                        <label>
                                                                                                                            ...
                                                                                                                            <input type="checkbox" name="hasForeignOwners" value="Yes" class="digital-input" ${bcpW9Form.hasForeignOwners eq 'Yes' ? 'checked' : ''} />
                                                                                                                        </label>
                                                                                                                    </td>
