...
<head>
    ...
    <title>BzPayroll - Created Timesheet</title>
                      ...
                      <table id="employeeTable">
                        <tbody id="custTableBody">
                          <c:forEach var="emp" items="${empList}">
                            ...
                            ${empty emp.ssn ? '' : emp.ssn} <br />
                            <strong>To be Paid Date:</strong> ${empty emp.toBePaidDate ? '' : emp.toBePaidDate} <br />
                            <strong>Hours to be Paid:</strong> ${empty emp.hoursToBePaid ? '0.00' : emp.hoursToBePaid} <br />
                            ${empty emp.payPeriod ? '' : emp.payPeriod}
                            </td>
                            </tr>
                          </c:forEach>
                        </tbody>
