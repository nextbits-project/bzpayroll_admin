...
<head>
    ...
    <title><spring:message code="BzComposer.crmCustomer.patner.editTitle"/></title>
...
<form:form name="CustomerForm" method="post" id="frmNewCustomer" modelAttribute="customerDto">
    ...
    <div id="cos">
		...
		<span style="font-size: 1.2em; font-weight: normal; color: #838383; margin: 30px 0px 15px 0px; border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
			<spring:message code="BzComposer.crmCustomer.patner.editTitle"/>
		</span>
                        </div>
                        ...
                        <div id="tabs" style="min-height:550px;">
                            <ul>
                                ...
                                <li><a href="#finance-4"><spring:message
                                        code="BzComposer.addnewcustomer.tabs.financecharges"/></a></li>
                            </ul>
                            <div id="General-1">
                                <div id="content1" class="tabPage">
                                    ...
                                    <div id="table-negotiations">
                                        <table class="tabla-listados" cellspacing="0">
                                            ...
                                            <tr>
                                                <th colspan="7">
                                                    <spring:message code="BzComposer.crmCustomer.patner.Details"/>
                                                </th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                                <td><spring:message code="BzComposer.crmCustomer.patner.Id"/></td>
                                            ...
                                            <tr>
                                                <td style="color: #black !important;">
                                                    <div class="lblZipcodeShow float-left"><spring:message
                                                            code="BzComposer.global.zipcode"/></div>
                                                    <div class="lblPostalcodeShow float-left"><spring:message
                                                            code="BzComposer.global.postalcodes"/></div>&nbsp;
                                                    <span class="inputHighlighted"><spring:message
                                                            code="BzComposer.CompulsoryField.Validation"/></span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <form:select path="city" id="cityID" style="width:200px;">
                                                        <form:option value="0"><spring:message
                                                                code="BzComposer.register.selectcity"/></form:option>
                                                        <c:forEach items="${cityList}" var="currObject">
                                                            <form:option
                                                                    value="${currObject.cityId}">${currObject.cityName}</form:option>
                                                        </c:forEach>
                                                    </form:select>
                                                </td>
                                                <td>
                                                    <div class="lblStateShow"><spring:message
                                                            code="BzComposer.global.state"/></div>
                                                    <div class="lblProvinceShow"><spring:message
                                                            code="BzComposer.global.province"/></div>
                                                </td>
                                                <td>
                                                    <form:select path="state" id="stateID"
                                                                 ...
                                                                 style="width:200px;">
                                                        <form:option value="0"><spring:message
                                                                code="BzComposer.register.selectstate"/></form:option>
                                                        <c:forEach items="${stateList}" var="currObject">
                                                            <form:option
                                                                    value="${currObject.stateId}">${currObject.state}</form:option>
                                                        </c:forEach>
                                                    </form:select>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <form:input path="cellPhone" maxlength="16"
                                                                onkeypress="return numbersonly(event,this.value)"
                                                                onchange="validateUSAPhoneNumber(this, true);"/>&nbsp;&nbsp;&nbsp;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form:select path="type">
                                                        ...
                                                        <form:options items="${VendorCategoryList}" itemValue="value"
                                                                      itemLabel="label"/>
                                                    </form:select>
                                                </td>
                                                <td><spring:message
                                                ...
                                                <td>
                                                    <input type="checkbox" name="isTaxable"
                                                           id="chktax" ${customerDto.taxAble=='on'?'checked':''} />
                                    ...
                                    <div id="table-negotiations">
                                        <table align="center" style="width: 100%" class="tabla-listados"
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    &nbsp;<input type="checkbox" id="chk_setaddress"
                                                ...
                                                <td>
                                                    <table class="tabla-listados" cellspacing="0" width="300"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3">
                                                                <form:input path="bscname" disabled="true"
                                                                            style="width:80%;"/>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3">
                                                                <form:input path="bsaddress1" disabled="true"
                                                                            style="width:80%;"/>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td colspan="3">
                                                                <form:input path="bsaddress2" disabled="true"
                                                                            style="width:80%;"/>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <div class="lblZipcodeShow"><spring:message
                                                                        code="BzComposer.global.zipcode"/></div>
                                                                <div class="lblPostalcodeShow"><spring:message
                                                                        code="BzComposer.global.postalcodes"/></div>
                                                            </td>
                                                            <td>
                                                                <form:input path="bszipCode" disabled="true"
                                                            ...
                                                            <td>
                                                                <form:select path="bscity" id="cityID2"
                                                                             style="width:200px;">
                                                                    <form:option value="0"><spring:message
                                                                            code="BzComposer.register.selectcity"/></form:option>
                                                                    <c:forEach items="${cityList}" var="currObject">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form:select path="bsstate" id="stateID2"
                                                            ...
                                                            <td>
                                                                <form:select path="bscountry" id="countryID2"
                                                ...
                                                <td>
                                                    <table class="tabla-listados" cellspacing="0" width="300"
                                                        ...
                                                        <tr>
                                                            <td><spring:message code="BzComposer.global.company"/></td>
                                                            <td colspan="3">
                                                                <form:input path="shcname" disabled="true"
                                                                            style="width:80%;"/>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3">
                                                                <form:input path="shaddress1" disabled="true"
                                                                            style="width:80%;"/>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td colspan="3">
                                                                <form:input path="shaddress2" disabled="true"
                                                                            style="width:80%;"/>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form:input path="shzipCode" disabled="true"
                                                            ...
                                                            <td>
                                                                <form:select path="shcity" id="cityID3"
                                                                             style="width:200px;">
                                                                    <form:option value="0"><spring:message
                                                                            code="BzComposer.register.selectcity"/></form:option>
                                                                    <c:forEach items="${cityList}" var="currObject">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form:select path="shstate" id="stateID3"
                                                            ...
                                                            <td>
                                                                <form:select path="shcountry" id="countryID3"
                                    ...
                                    <div id="table-negotiations" style="width:100%">
                                        <table class="tabla-listados" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5">
                                                    <form:select path="ccType" style="width:150px;">
                                                        ...
                                                        <form:options items="${CreditCardList}" itemValue="value"
                                                                      itemLabel="label"/>
                                                    </form:select>
                                                </td>
                                                <td colspan="4">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <form:input path="cardNo" style="width:225px;"
                                                                onkeypress="return numbersonly(event,this.value);"/>
                                                </td>
                                                <td colspan="3">
                                        ...
                                        <table class="tabla-listados" cellspacing="0" style="width: 100%">
                                            ...
                                            <tr>
                                                <th colspan="12">
                                                    <strong>
                                                        <spring:message
                                                                code="BzComposer.addnewcustomer.defaultserviceheader"/>
                                                    </strong>
                                                </th>
                                            </tr>
                                            </thead>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <button type="button" class="formbutton"
                                                            onclick="addToTable(this.form);"><spring:message
                                                            code='BzComposer.global.add'/></button>
                                                </td>
                                                <td colspan="3">
                                                    &nbsp;
                                                </td>
                                                    ...
                                                    <c:forEach items="${ServiceInfo}" var="objList" varStatus="loop">
                                                        ...
                                                        <tr id='row${objList.serviceID}'>
                                                            ...
                                                            <c:if test="${objList.defaultService == 1}">
                                                                <td>
                                                                    <input type="radio" name="defaultService"
                                ...
                                <div id="content4" class="tabPage">
                                    ...
                                    <div id="table-negotiations" style="width:100%">
                                        <table class="tabla-listados" cellspacing="0">
                                            ...
                                            <tr>
                                                <td>
                                                    <input value="on" type="checkbox" id="chk_useind"
                                                           name="UseIndividualFinanceCharges"
                                                           onclick="toggleFields(this.form);">
                                                    <font size="2">
                                                        <spring:message
                                                            ...
                                                            <table class="tabla-listados" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        <form:input
                                                                                onkeypress="return numbersonly(event,this.value)"
                                                                                path="minFCharges" readonly="true"/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="4">
                                                                        <input type="checkbox" id="chk1"
                                                                               name="AssessFinanceChk" readonly="true"
                                                                               value="${customerDto.fsAssessFinanceCharge}" ${customerDto.fsAssessFinanceCharge=='on'?'checked':''} />
                                                                        <spring:message
                                                                ...
                                                                <tr>
                                                                    <td colspan="4">
                                                                        <input type="checkbox" id="chk2"
                                                                               name="FChargeInvoiceChk" readonly="true"
                                                                               value="${customerDto.fsMarkFinanceCharge}" ${customerDto.fsMarkFinanceCharge=='on'?'checked':''} />
                                                                        <spring:message
                            ...
                            <tr>
                                <td align="center">
                                    <button type="button" class="formbutton" title="New Customer"
                                            onclick="NewCustomer();"><spring:message
                                            code='BzComposer.global.new'/></button>
                                    <button type="button" class="formbutton" title="Save Customer"
                                            onclick="CheckMambership();"><spring:message
...
<script>
    ...
    function CheckMambership() {
        ...
        var gold = "gold";
        var silver = "silver";
        if (membershipLevel.toLowerCase() === st.toLowerCase()||membershipLevel.toLowerCase() === silver.toLowerCase()) {
            if (size >= 1000) {
                return maxnumberofuserdialog();
            } else {
                return AddCustomer();
            }
        } else if (membershipLevel.toLowerCase() == pf.toLowerCase()||membershipLevel.toLowerCase() == gold.toLowerCase()) {
            if (size >= 10000) {
