...
<title>BzComposer - <spring:message code="BzComposer.importPurchaseOrder"/></title>
...
function downloadTemplate(type){
	...
	document.forms[0].action = "dataImportAction?tabid=DownloadPurchaseOrderTemplate&type="+type;
...
<div style="margin: 20px 10px 0px 40px;">
	<span style="font-size: 1.2em; font-weight: normal; color: #05A9C5 !important;">
		<spring:message code="BzComposer.importPurchaseOrder" />
	</span>
</div>
<div>
<form:form action="dataImportAction?tabid=PurchaseOrders" method="post" enctype="MULTIPART/FORM-DATA">
	<div style="margin: 20px 10px 0px 40px;">
