...
<div style="margin: 20px 10px 0px 40px;">
	<span style="font-size: 1.2em; font-weight: normal; color: #05A9C5 !important;">
		<spring:message code="BzComposer.exportlead" />
	</span>
</div>
<div>
<form:form action="File?tabid=ExportLeads" method="post" enctype="MULTIPART/FORM-DATA" styleId="uploadForm" modelAttribute="companyInfoDto">
    <div style="margin: 20px 10px 0px 40px;">
	<table>
		<tr>
