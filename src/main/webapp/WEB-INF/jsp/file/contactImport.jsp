...
<ol>
  ...
  <li>After uploading Contacts you need to edit them and change the various fields(if you want?).</li>
  <li>If any Contacts data not imported then it means your Phone number and Email matched with existing data.</li>
</ol>
</div>
<div>
