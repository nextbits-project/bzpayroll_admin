...
<form:form action="AllLeads?tabid=leadList" method="post" id="frmNewContact" name="frmNewContact" modelAttribute="campaignMemberDto">
	<!-- begin shared/header -->
		...
		<div class="statusquo ok">
			<div id="hoja">
				<div id="blanquito">
					...
					<div id="table-negotiations"  style="padding: 10px 10px; border: 1px solid #ccc; width:100%;"  align="center">
						...
						<table cellspacing="0"  class="tabla-listados"
							...
							<td colspan="2" style="text-align: center">
							 <b> ${campaignMemberDto.selectedMembers} Contacts  Selected </b>
							 </td>
							</tr>
							...
							<tr>
								  ...
								  <tr >
								 	<th ><b><spring:message code="BzComposer.campaign.exitingCampaign" /> </b> </th>
								 	
								  <tr>
								  <tr>
								  <td>
								  <form:radiobutton path="updateStatus" value="false"   checked="checked" />
                    ...
                    <form:radiobutton path="updateStatus"  value="true"/>
                     <spring:message code="BzComposer.campaign.updateexistingMemberStatus" /><br>
								  </td>
								  </tr>
								  <tr>
									...
									<tr >
										<td colspan="6">
											...
											<input type="button" class="formbutton"
												...
												<input type="button" class="formbutton"
													onclick="addContact();" style="padding: 7 15px;"
...
function addContact() 
{
		...
		document.forms["frmNewContact"].action = "Campaign?tabid=saveContactToCampaign";
		
		document.forms["frmNewContact"].submit();
