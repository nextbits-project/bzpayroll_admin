...
<form:form name="TaskForm" method="post" id="frmNewCustomer" modelAttribute="taskDto">
    ...
    <div id="cos">
		...
		<span style="font-size: 1.2em; font-weight: normal; color: #838383; margin: 30px 0px 15px 0px; border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
			<spring:message code="BzComposer.CustomerBoard.addNewTask"/>
		</span>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <div id="table-negotiations">
                                        <table class="tabla-listados" cellspacing="0">
                                            ...
                                            <tr>
                                                <th colspan="7">
                                                    <spring:message code="BzComposer.CustomerBoard.taskDetails"/>
                                                </th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr >
                                                <td><spring:message code="BzComposer.CustomerBoard.taskID"/>
                                            ...
                                            <tr>
                                                <td>
                                                                <spring:message code="BzComposer.CustomerBoard.dueDate"/>
														...
														<td><form:input path="dueDate" readonly="true" />
															...
															onclick="displayCalendar(document.TaskForm.dueDate,'mm-dd-yyyy',this);">
														</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <td><spring:message code="BzComposer.CustomerBoard.contactName"/><span class="inputHighlighted"><spring:message
                                               	...
                                               	<td><form:select path="contactName"
                                                            ...
                                                            <form:option
                                                                    value="${currObject.campaignMemberID}">${currObject.firstName} ${currObject.lastName}
                                                               </form:option>
                                                        </c:forEach>
                                                        </form:select>
                                        ...
                                        <td >
                                                 ...
                                                 <td><form:input path="relatedTo" style="width:250px;"/></td>
                                       ...
                                       <tr>
                                                <td>
                                                    <spring:message code="BzComposer.CustomerBoard.assignedTo"/>
                                                    <span class="inputHighlighted"><spring:message
                                                            code="BzComposer.CompulsoryField.Validation"/></span>
                                                </td>
                                                <td colspan="3">
                                                    
                                                    <form:select path="assignedTo" style="width:200px">
                                                ...
                                                <tr>
                                                <td>
                                                    <spring:message code="BzComposer.CustomerBoard.status"/>
                                                 ...
                                                 <td colspan="3">
                                                    ...
                                                    <form:select path="status" style="width:200px">
																...
																<form:option value="Planned">
																	<spring:message code="BzComposer.CustomerBoard.planned" />
																</form:option>
																<form:option value="In Progress">
																	<spring:message code="BzComposer.CustomerBoard.inProgress" />
																</form:option>
																<form:option value="Completed">
																	<spring:message code="BzComposer.CustomerBoard.completed" />
																</form:option>
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <button type="button" class="formbutton" title="Save Task"
                                            onclick="saveTask();"><spring:message
	 ...
	 function saveTask()
	    {
	    	...
	    	var dueDate=document.TaskForm.dueDate.value;
	    	var clientVendorID=document.TaskForm.clientVendorID.value;
	    	var assignedTo=document.TaskForm.assignedTo.value;
	    	var relatedTo=document.TaskForm.relatedTo.value;
	    	 var status= document.TaskForm.status.value;
	    	 var  campaignID= document.TaskForm.campaignID.value;
	    	
	    	 var type="campaign";
	    	
	    	
	    	 
	    	 if(subject==""||dueDate==""||contactID==""||relatedTo==""||assignedTo==""||status=="")
	    		 {
	    			showErrorDialog();
	    		 return false ;
	    		 }
		 ...
		 $.ajax({
		 		type : "POST",
		 		url : "manageActivity?tabid=saveTask",
		 	    data :"data=" + obj,
