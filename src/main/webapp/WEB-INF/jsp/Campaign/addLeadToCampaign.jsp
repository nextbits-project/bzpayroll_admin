...
<form:form action="AllLeads?tabid=leadList" method="post" id="" name="frmNewLead" modelAttribute="campaignMemberDto">
	<!-- begin shared/header -->
				...
				<div id="blanquito">
						...
						<div align="center">
							<div style="float: center;">
								<span
									...
									<spring:message code="BzComposer.campaign.addLeadCampaign" />
									 <c:if
					...
					<div id="table-negotiations"  style="padding: 10px 10px; border: 1px solid #ccc; width:100%;"  align="center">
						...
						<table cellspacing="0"  class="tabla-listados"
							...
							<tr >
							<td colspan="2">
							 <b> ${campaignMemberDto.selectedMembers} Leads  Selected </b>
							 </td>
							</tr>
							...
							<tr>
											<td colspan="2"><spring:message code="BzComposer.sales.campaign" />
															...
															<td>
															<form:select path="campaignID" id="countryID"
...
function addNewLead()
{
	document.forms["frmNewLead"].action = "Campaign?tabid=saveLeadToCampaign";
