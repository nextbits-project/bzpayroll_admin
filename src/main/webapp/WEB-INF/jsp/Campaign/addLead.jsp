...
<title><spring:message code="BzComposer.campaign.addLeadToCampaign" /></title>
<style>
					...
					<div id="padding">
						...
						<div align="center">
							<div style="float:center;">
								<span
									style="font-size: 1.2em; font-weight: bold; color: #838383; margin: 30px 0px 15px 0px; border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
									<spring:message code="BzComposer.campaign.addLeadToCampaign" /> 
									
									</span>
									
									<span
									style="font-size: 1em; font-weight: normal; color: #838385; margin: 30px 0px 15px 0px; border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
...
function gotoNext()
{
	 ...
	 if (selectedRowIndexs.length == 0)
	 {
	        ...
	        {
	        	LeadIDs = LeadIDs + selectedRowIndexs[x] +":";
	        }
	        LeadIDs = LeadIDs.substring(0, LeadIDs.length-1);
	          
            window.location="/Campaign?tabid=addLeadCampaign&LeadIDs="+LeadIDs;	
}
function initialize(){
