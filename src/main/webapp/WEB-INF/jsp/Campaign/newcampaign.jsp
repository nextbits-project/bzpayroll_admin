						...
						<div id="padding">
							...
							<div>
								<span
									...
									<spring:message code="BzComposer.campaign.title" />
								</span>
							</div>
							<div>
								<span
											...
											<table class="tabla-listados" cellspacing="30px">
												...
												<tbody>
													...
													<tr>
														...
														<td><form:select path="status" onchange="loadStatesByCountryID(this.value, 1);"
																style="width:200px">
						...
						exist[i]=-1;
								...
								<tr>
									<td align="center">
										...
										<button type="button" class="formbutton" title="Save Campaign" onclick="newCampaign();">
...
function CheckMambership() {
	...
	function newCampaign()
	{
		...
		/*
		if (document.CampaignForm.companyName.value == "") {
			document.CampaignForm.cname.focus();
			return showNameDialog();
		} else if (document.CampaignForm.firstName.value == "") {
			document.CampaignForm.firstName.focus();
			return showFirstNameDialog();
		} else if (document.CampaignForm.lastName.value == "") {
			document.CampaignForm.lastName.focus();
			return showLastNameDialog();
		} else if (document.CampaignForm.address1.value == "") {
			document.CampaignForm.address1.focus();
			return showAddress1Dialog();
		} else if (document.CampaignForm.city.value == "") {
			document.CampaignForm.city.focus();
			return showCityDialog();
		} else if (document.CampaignForm.zipCode.value == "") {
			document.CampaignForm.zipCode.focus();
			return showZipCodeDialog();
		} else if (String(document.CampaignForm.cellPhone.value).length > 16) {
			document.CampaignForm.cellPhone.value = "";
			document.CampaignForm.cellPhone.focus();
						...
						.dialog(
								{
									...
									buttons : {
										"<spring:message code='BzComposer.global.ok'/>" : function() {
											...
											document.forms["frmNewCampaign"].action = "Campaign?tabid=saveCampaign";
...
<div id="addNewCustomerDialog" style="display: none;">
	<p>
		<spring:message code="BzComposer.campaign.message.saveCampaign" />
	</p>
</div>
