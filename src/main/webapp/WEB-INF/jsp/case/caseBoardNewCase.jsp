									...
									<div id="content1" class="tabPage">
										...
										<div id="table-negotiations">
											...
											<table class="tabla-listados"  cellspacing="0"
													...
													<tr>
														...
														<td><spring:message
															...
															class="inputHighlighted"><spring:message
																...
																<td><form:select path="companyName"
																style="width:200px"  onchange="loadCustomerContact(this.form);">
												...
												<tr>
													<td><spring:message
															code="BzComposer.customer.case.product" /> 
															<span
														class="inputHighlighted"><spring:message
												...
												<tr>
													...
													<td>
													<form:checkbox path="mailToContact" /> <spring:message
															code="BzComposer.customer.case.mailToContact" />
													</td>
												</tr>
							...
							<table cellpadding="0" cellspacing="0" border="0" align="center"
								...
								<tr>
									<td align="center">
										...
										<button type="button" class="formbutton" title="Save Case" onclick="addCase()">
...
function numbersonly(e,val)
{
						...
						.dialog(
								{
									...
									buttons : {
										"<spring:message code='BzComposer.global.ok'/>" : function() {
											...
											document.forms["frmNewCase"].action = "/caseBoardCreateCase";
	...
	function loadCustomerContact()
	{
		...
		document.newCaseForm.clientVendorID.value=document.newCaseForm.companyName.value;
   	  $.ajax({
	        type: "GET",
	        url:"/caseData?tabid=getContactsbyClientVendor&cvId="+document.newCaseForm.companyName.value,
	        success:function(data)
	        {
	        	 ...
	        	 {
	        		  catOptions += "<option value="+data[i].contactID+">" + data[i].firstName +" "+data[i].lastName+ "</option>";
	        	 }
	        	 document.getElementById("contactName").innerHTML = catOptions;
