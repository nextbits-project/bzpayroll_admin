							...
							<thead>
								<tr valign="top">
									<th class="emblem" style="font-size:12px;">
										<div align="center">
											<spring:message code="BzComposer.customerinfo.lead" />
										</div>
									</th>
								</tr>
							</thead>
								...
								<thead>
									<tr>
										<th colspan="3" style="font-size:12px;">
											<spring:message code="BzComposer.customerinfo.leadinformation"/>
										</th>
									</tr>
								</thead>
								<tbody>
								    <tr>
								        <td style="width: 40%;">
								            <table cellspacing="0" class="tabla-listados">
								                <tr>
                                                    <td style="width: 50%;"><strong><spring:message code="BzComposer.global.leadid" />:</strong></td>
