...
<head>
    ...
    <title>
        <spring:message code="BzComposer.CreditMemoListTitle" />
    </title>
    <style type="text/css">
        .fht-tbody {
...
<body onload="Init();">
    <form:form id="invoiceForm" name="salesboardForm" action="SalesBord?tabid=ShowList"
        method="post" modelAttribute="creditMemoBoardDto">
        <div id=""></div>
                        ...
                        <div id="padding">
                            <div>
                                ...
                                <span
                                    ...
                                    <spring:message
                                        code="BzComposer.CreditMemoBoard" />
                            ...
                            <div>
                                <div id="table-negotiations">
                                            ...
                                            <td style="width: 30%; padding: 10px;">
                                                <table
                                                    ...
                                                    <tr>
                                                        <th colspan="2">
                                                            <spring:message
                                                                code="BzComposer.estimationboard.filteroption" />
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <spring:message
                                                                code="BzComposer.salesorderboard.daterange" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <spring:message
                                                                code="BzComposer.salesorderboard.orderdate" />
                                                            <spring:message
                                                        ...
                                                        <td>
                                                            <spring:message
                                                                code="BzComposer.salesorderboard.orderdate" />
                                                            <spring:message
                                                                code="BzComposer.salesorderboard.to" />
                                                            :
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 50%;">
                                                            <form:input path="orderDate1" size="20"
                                                        ...
                                                        <td>
                                                            <form:input path="orderDate2" size="20"
                                                                style="width: 120px;" /> <img
                                                                style="margin: 5;"
                                                                src="${pageContext.request.contextPath}/images/cal.gif"
                                            ...
                                            <td style="width: 25%; padding: 10px;">
                                                <table
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <spring:message
                                                                code="BzComposer.invoiceboard.order" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <spring:message
                                                                code="menu.quickbook.from" /> :
                                                        </td>
                                                        <td>
                                                            <spring:message
                                                                code="menu.quickbook.to" /> :
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 50%;">
                                                            <form:input path="orderNoFrom"
                                                                style="width: 120px;"
                                                                onkeypress="return numbersonly(event, this.value)" />
                                                        </td>
                                                        <td>
                                                            <form:input path="orderNoTo"
                                                                style="width: 120px;"
                                                                onkeypress="return numbersonly(event, this.value)" />
                                                        </td>
                                                    </tr>
                                            ...
                                            <td style="width: 25%;">
                                                <table style="width: 100%; font-size: 14px;"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <spring:message
                                                                code="BzComposer.estimationboard.column" />
                                                        </td>
                                                        <td>
                                                            <form:select path="searchType"
                                                                ...
                                                                <option value="1">
                                                                    <spring:message
                                                                        code="BzComposer.estimationboard.name" />
                                                                </option>
                                                                <option value="2">
                                                                    <spring:message
                                                                        code="BzComposer.estimationboard.order" />
                                                                </option>
                                                                <option value="3">
                                                                    <spring:message
                                                                        code="BzComposer.estimationboard.orderid" />
                                                                </option>
                                                                <option value="4">
                                                                    <spring:message
                                                                        code="BzComposer.estimationboard.address" />
                                                                </option>
                                                                <option value="5">
                                                                    <spring:message
                                                                        code="BzComposer.estimationboard.productname" />
                                                                </option>
                                                                <option value="6">
                                                                    <spring:message
                                                                        code="BzComposer.estimationboard.email" />
                                                                </option>
                                                            </form:select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <spring:message
                                                                code="BzComposer.estimationboard.text" />
                                                        </td>
                                                        <td>
                                            ...
                                            <td style="width: 20%;">
                                                <div>
                                                    <button type="button" class="formbutton"
                                                        onclick="SaleSearch(1);"
                                                        style="width: 70px;">
                                                        <spring:message
                                                            code='BzComposer.estimationboard.search' />
                                                    </button>
                                                </div>
                                                <div>
                                                    <button type="button" class="formbutton"
                                                        ...
                                                        <spring:message
                                                            code='BzComposer.estimationboard.refresh' />
                                                    </button>
                                                </div>
                                                <div>
                                                    <button type="button" class="formbutton"
                                                        ...
                                                        <spring:message
                                                            code='BzComposer.estimationboard.clear' />
                                                    </button>
                                                    <button type="button" class="formbutton"
                                                        onclick="downloadInvoiceBoardReport();"
                                                        style="width: 110px; margin-top: 10px;">
                                                        <spring:message
                                                            code='BzComposer.global.MultiPrint' />
                                                    </button>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <div>
                                        ...
                                        <table style="width: 100%">
                                            <tr align="center">
                                                ...
                                                <td style="width: 40%" align="left"><span
                                                        style="font-size: 1.2em; font-weight: normal; color: #838383; margin: 30px 0px 15px 0px; border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
                                                        <spring:message
                                                            code="BzComposer.CreditMemoList" />
                                                    </span></td>
                                                <td style="width: 60%" align="left">
                                                    <form:hidden path="deletedRecords"
                                                        value="value" />

                                                    <input type="hidden" id="deleteRecordsID"
                                                        name="deletedIDS" value="">
                                                    <input type="button"
                                                        class="formbutton" style="padding: 10px;"
                                                        onclick="EditMemo();"
                                                    ...
                                                    <input type="hidden" name="sEmail"
                                                        id="sEmailID"> <input type="hidden"
                                                        name="rNum" id="rowONum"> <input
                                                        type="hidden" name="senderEmail" id="EID">
                                                </td>
                                            </tr>
                                        </table>
                                        <div>
                                            <div class="grid_8 tabla-listados"
                                                id="invoiceOrderList">
                                                <section>
                                                    <c:forEach items="${SalesBoardDetails}"
                                                        var="currObject" varStatus="loop">
                                                        <input type="hidden"
                                                            id="selectedInvID${loop.index}"
                                                        ...
                                                        <thead style="font-weight: bold;">
                                                            <tr>
                                                                <th style="font-size: 14px;"><input
                                                                        ...
                                                                        onchange="getAllRecordsIDs(this)" />
                                                                    <spring:message
                                                                        code="eSalesInvoiceDetails.All" />
                                                                </th>
                                                                <th style="font-size: 14px;">
                                                                    <spring:message
                                                                        code="BzComposer.CreditMemoBoard.InvoiceNumber" />
                                                                </th>
                                                                <th style="font-size: 14px;">
                                                                    <spring:message
                                                                        code="BzComposer.CreditMemoBoard.Date" />
                                                                </th>
                                                                <th style="font-size: 14px;"><spring:message
																		code="BzComposer.invoiceboard.companyname" />
                                                                </th>
                                                                <th style="font-size: 14px;"><spring:message
																		code="BzComposer.invoiceboard.name" />
                                                                </th>
                                                                <th style="font-size: 14px;">
                                                                    <spring:message
                                                                        code="BzComposer.CreditMemoBoard.Amount" />
                                                                </th>
                                                                <th style="font-size: 14px;">
                                                                    <spring:message
                                                                        code="BzComposer.CreditMemoBoard.ReasonCredit" />
                                                                </th>
                                                                <th style="font-size: 14px;">
                                                                    <spring:message
                                                                        code="BzComposer.CreditMemoBoard.Terms" />
                                                                </th>
                                        ...
                                        <input type="hidden" id="statusId" name="StatusValue"
                                            value=""> <input type="hidden" id="ordSize" name="Size"
                                            value="">
                                        ...
                                        <table align="center" class="d-none">
                                            <tr align="center">
                                                <td><input type="button"
                                                        style="padding: 10px;" class="formbutton"
                                                        id="smail" onclick="sendToInvoice()"
                                                    ...
                                                    <input type="button" class="formbutton"
                                                        id="modi"
                                                        onclick="DeleteInvoicesOrderBoard('DELETE');"
                                                        style="padding: 10px;"
                                                        value='<spring:message code="BzComposer.global.delete" />' />
                                                    <input type="hidden" name="ONum" id="ONumId">
                                                    <input type="hidden" name="sEmail"
...
<script type="text/javascript">
    ...
    var prev;
    function isPaymentCompleted(invoiceId) {
        var checked = $("#paymentCompletedId").prop('checked');
        if (checked == true) {
            $.ajax({
                type: "POST",
                url: "SalesAjax?tabid=isPaymentCompleted&invoiceId=" + invoiceId + "&isPaymentCompleted=1",
            ...
            $.ajax({
                type: "POST",
                url: "SalesAjax?tabid=isPaymentCompleted&invoiceId=" + invoiceId + "&isPaymentCompleted=0",
                success: function (data) {
                },
                error: function (data) {
                    alert("Error occurred");
    ...
    function isPrinted(invoiceId) {
        var checked = $("#isPrintedId").prop('checked');
        if (checked == true) {
            $.ajax({
                type: "POST",
                url: "SalesAjax?tabid=isPrinted&invoiceId=" + invoiceId + "&isPrinted=1",
                success: function (data) {
                },
                error: function (data) {
                    alert("Error occurred");
            ...
            $.ajax({
                type: "POST",
                url: "SalesAjax?tabid=isPrinted&invoiceId=" + invoiceId + "&isPrinted=0",
                success: function (data) {
                },
                error: function (data) {
                    alert("Error occurred");
    ...
    function isShipped(invoiceId) {
        var checked = $("#shippedId").prop('checked');
        if (checked == true) {
            $.ajax({
                type: "POST",
                url: "SalesAjax?tabid=isShipped&invoiceId=" + invoiceId + "&isShipped=1",
                success: function (data) {
                },
                error: function (data) {
                    alert("Error occurred");
            ...
            $.ajax({
                type: "POST",
                url: "SalesAjax?tabid=isShipped&invoiceId=" + invoiceId + "&isShipped=0",
                success: function (data) {
                },
                error: function (data) {
                    alert("Error occurred");
    ...
    function isEmailClick(invoiceId) {
        var checked = $("#isEmailId").prop('checked');
        if (checked == true) {
            $.ajax({
                type: "POST",
                url: "SalesAjax?tabid=isEmailed&invoiceId=" + invoiceId + "&isEmailed=1",
                success: function (data) {
                },
                error: function (data) {
                    alert("Error occurred");
            ...
            $.ajax({
                type: "POST",
                url: "SalesAjax?tabid=isEmailed&invoiceId=" + invoiceId + "&isEmailed=0",
                success: function (data) {
                },
                error: function (data) {
                    alert("Error occurred");
    ...
    function SendMail(form) {
        if (selectedRowIDs.length !== 1) {
            ...
            const order_no = document.getElementById("ord_value").value;
            const url = "Invoice?tabid=ShowEmail&OrderType=invoice&OrderNo=" + encodeURIComponent(order_no);
            window.open(
                url,
                "_blank",
                "scrollbars=yes,height=500,width=900,status=yes,toolbar=no,menubar=no,location=no"
            );
        }
    }
    function EditMemo() {
        if (selectedRowIDs.length !== 1) {
            ...
            const order_no = document.getElementById("ord_value").value;
            const url = "SalesBord?tabid=EditCreditMemo&OrderNo=" + encodeURIComponent(order_no);
            window.open(
                url,
                "_blank",
                "scrollbars=yes,height=500,width=900,status=yes,toolbar=no,menubar=no,location=no"
    ...
    function deleteInvoices() {
        $.ajax({
            type: "POST",
            url: "SalesBord?tabid=DeleteCreditMemo",
            data: "deletedInvoices=" + selectedRowIDs,
            success: function (data) {
                window.location = "SalesBord?tabid=CreditMemoList&status=1";
            },
            error: function (data) {
    ...
    function deleteInvoiceDialog(form) {
        if (selectedRowIDs.length == 0) {
            ...
            $("#deleteCreditMemoRecordDialog").dialog({
                resizable: false,
                height: 200,
                width: 500,
                modal: true,
    ...
    function SaleSearch(filterType) {
        ...
        $.ajax({
            type: "POST",
            url: "SalesBord?tabid=CreditMemoList",
...
<div id="warningDialog" title="Warning .." style="display: none;">
    <p>
        <spring:message code="BzComposer.CreditMemoBoard.warningdeleteCreditMemoListRecord" />
    </p>
</div>

<div id="warningDialogSendmail" title="Warning .." style="display: none;">
    <p>
        <spring:message code="BzComposer.global.selectone" />
    </p>
</div>
<div id="deleteCreditMemoRecordDialog" title="Delete Invoice" style="display: none;">
    <p>
        <spring:message code="BzComposer.CreditMemoBoard.deleteCreditMemoListRecord" />
    </p>
</div>