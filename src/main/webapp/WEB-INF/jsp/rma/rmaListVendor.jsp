...
<div align="center">
	<table style="width:100%">
		...
		style="font-size: 1.2em; font-weight: normal; color: #838383; margin: 30px 0px 15px 0px; border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
			<spring:message code="BzComposer.rmalist.vendorrmalist" /></span>
		</td>
		<td style="width:60%">
		<a href="PurchaseBoard?tabid=ShowList" class="formButton">
      ...
      <table  id="rmaData" class="tabla-listados dataTable tableRma" cellpadding="0" cellspacing="0">
		...
		<thead style="font-weight: bold;">
			<tr>
				...
				<th class="emblem" align="left" nowrap="nowrap" style="font-size: 14px;">
					<spring:message code="BzComposer.rmalist.pono" />
				</th>
				<th class="emblem" align="left" nowrap="nowrap" style="font-size: 14px;">
...
function getRMA()
{
	...
	rmawindow=window.open("RMA?tabid=RmaInfoPO&invoiceID="+invoiceID+"&rmaNo="+rnum,null,"scrollbars=yes,height=700,width=1400,status=yes,toolbar=no,menubar=no,location=no" );
