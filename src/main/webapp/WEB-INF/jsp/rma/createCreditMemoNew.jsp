...
<head>
    ...
    <title>
        <spring:message code='BzComposer.CreditMemo.title'/>
    </title>
    <!-- Bootstrap 5 -->
                    ...
                    <div id="padding">
                        <div class="pt-3 pb-3">
                            <span style="font-size: 1.2em;">
                                <spring:message code="BzComposer.rma.create.credit.memo" />
                            </span>
                        </div>
...
function onSave(){
    ...
    $.ajax({
        type: "POST",
        url: "SalesBord?tabid=saveCreditMemo",
        data: "data=" + obj,
        success: function (data) {
            showSuccessDialog();
        }
...
<div id="showSuccessDialog" style="display:none;">
    <p><spring:message code="BzComposer.CreditMemo.saveCreditMemo"/></p>
</div>
</html>