...
<title><spring:message code="BzComposer.nonprofit.donationboardtitle" /></title>
<style type="text/css">
.fht-tbody {
...
<body onload="Init();">
	...
	<form:form id="SalesBoardForm" name="salesboardForm"
		...
		modelAttribute="donationBoardDto">
		<div id="">
							...
							<div id="padding">
								<div>
									...
									<span
										...
										<spring:message
											code="BzComposer.donationboard.donationboard" /> <c:if
											test="${not empty msg}">
											<div>*${msg}</div>
											...
											<tr>
												<td style="width: 30%; padding: 10px;">
													<table
														...
														<tr>
															<td><spring:message
																	code="BzComposer.nonprofit.donationBoard.donationDateFrom" /> :</td>
															<td><spring:message
																	code="BzComposer.nonprofit.donationBoard.donationDateTo" /> :</td>
														</tr>
														<tr>
												...
												<td style="width: 25%; padding: 10px;">
													<table
														...
														<tr>
															<td colspan="2"><spring:message
																	code="BzComposer.nonprofit.donationBoard.donationNo" /></td>
														</tr>
														<tr>
										...
										<div>
											...
											<table style="width: 100%">
												<tr>
													...
													<td style="width: 40%" align="left"><span
														style="font-size: 1.2em; font-weight: normal; color: #838383; margin: 30px 0px 15px 0px; border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
															<spring:message
																code="BzComposer.donationboard.donationlist" />
													</span></td>
											...
											<div>
												<div class="grid_8 tabla-listados" id="salesOrderList">
													<section>
														<c:forEach items="${DonationBoardDetails}"
														...
														<input type="hidden" name="sListSize" id="lSize"
															value='${DonationBoardDetails.size()}' />
															...
															<thead style="font-weight: bold;">
																<tr>
																	...
																	<th style="font-size: 14px;"><spring:message
																			code="BzComposer.nonprofit.donationBoard.donationNo" /></th>
																	<th style="font-size: 14px;"><spring:message
																	...
																	<th style="font-size: 14px;"><spring:message
																			code="BzComposer.nonprofit.donation.Amount" /></th>
															...
															<tbody>
																<c:forEach items="${DonationBoardDetails}"
																	...
																	<tr id='${loop.index}$$' ondblclick="sendToOrder()"
																		onclick="setRowId(${objList.donationNum}, ${loop.index}, true);">
																		<td><input type="hidden" class="invoiceID"
																			...
																			value="${objList.donationNum}" /></td>
																		<td style="font-size: 14px;">${objList.donationNum}</td>
...
function sendToOrder(){
	...
	window.location = "NonProfit?tabid=DBLU&donationNo="+order_no;
}
...
function SendMail(form)
{
	...
	order_no = document.getElementById("ord_value").value;
	window.open("Invoice?tabid=ShowEmail&OrderType=Donation&OrderNo=" + order_no, null, "scrollbars=yes,height=500,width=900,status=yes,toolbar=no,menubar=no,location=no");
	 }
	 }
...
function deleteDonation()
{
    ...
    $.ajax({
        type : "POST",
        url : "SalesAjax?tabid=DeleteDonation&DonationNo="+rowId,
        data:"DonationNo="+selectedRowIDs,
        success : function(data){
			window.location="NonProfit?tabid=DonationBoard&status=1";
        },
		error : function(data) {
	...
	$("#deleteSalesOrder").dialog({
        ...
        buttons: {
            ...
            "<spring:message code='BzComposer.global.cancel'/>": function () {
                $(this).dialog("close");
                window.location="NonProfit?tabid=DonationBoard";
                return false;
            }
        }
    });
...
<div id="deleteSalesOrder" title="Delete Sales Order"
	...
	<p>
		<spring:message
			code="BzComposer.nonprofit.donationBoard.deletemessage" />
	</p>
...
<div id="warningDialog" title="Warning !" style="display: none;">
	<p>
		<spring:message
			code="BzComposer.nonprofit.donationBoard.selectdonationwarning" />
	</p>
