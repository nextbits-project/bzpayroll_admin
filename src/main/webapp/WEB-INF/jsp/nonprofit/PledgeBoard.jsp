...
<title><spring:message code="BzComposer.nonprofit.pledgeboardtitle" /></title>
<style type="text/css">
.fht-tbody {
							...
							<div id="padding">
								<div>
									...
									<span
										...
										<spring:message
											code="BzComposer.nonprofit.pledgeboard" /> <c:if
											test="${not empty msg}">
											<div>*${msg}</div>
											...
											<tr>
												<td style="width: 30%; padding: 10px;">
													<table
														...
														<tr>
															<td><spring:message
																	code="BzComposer.nonprofit.pledgeBoard.pledgeDateFrom" /> :</td>
															<td><spring:message
																	code="BzComposer.nonprofit.pledgeBoard.pledgeDateTo" /> :</td>
														</tr>
														<tr>
												...
												<td style="width: 25%; padding: 10px;">
													<table
														...
														<tr>
															<td colspan="2"><spring:message
																	code="BzComposer.nonprofit.pledgeBoard.pledgeNo" /></td>
														</tr>
														<tr>
										...
										<div>
											...
											<table style="width: 100%">
												<tr>
													...
													<td style="width: 40%" align="left"><span
														style="font-size: 1.2em; font-weight: normal; color: #838383; margin: 30px 0px 15px 0px; border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
															<spring:message
																code="BzComposer.pledgeboard.pledgelist" />
													</span></td>
											...
											<div>
												<div class="grid_8 tabla-listados" id="salesOrderList">
													<section>
														<c:forEach items="${PledgeBoardDetails}"
															...
															<thead style="font-weight: bold;">
																<tr>
																	...
																	<th style="font-size: 14px;"><spring:message
																			code="BzComposer.nonprofit.pledgeBoard.pledgeNo" /></th>
																	<th style="font-size: 14px;"><spring:message
																	...
																	<th style="font-size: 14px;"><spring:message
																			code="BzComposer.nonprofit.pledge.Amount" /></th>
															...
															<tbody>
																<c:forEach items="${PledgeBoardDetails}"
																	...
																	<tr id='${loop.index}$$' ondblclick="sendToOrder()"
																		onclick="setRowId(${objList.pledgeNum}, ${loop.index}, true);">
																		<td><input type="hidden" class="invoiceID"
																			...
																			value="${objList.pledgeNum}" /></td>
																		<td style="font-size: 14px;">${objList.pledgeNum}</td>
...
function sendToOrder(){
	...
	window.location = "NonProfit?tabid=PBLU&pledgeNo="+order_no;
}
...
function SendMail(form)
{
	...
	order_no = document.getElementById("ord_value").value;
	window.open("Invoice?tabid=ShowEmail&OrderType=Pledge&OrderNo=" + order_no, null, "scrollbars=yes,height=500,width=900,status=yes,toolbar=no,menubar=no,location=no");
	 }
	 }
...
function deletePledge()
{
	...
	$.ajax({
        type : "POST",
        url : "SalesAjax?tabid=DeletePledge&PledgeNo="+rowId,
        data:"DeletedPledge="+rowId,
        success : function(data){
			window.location="NonProfit?tabid=PledgeBoard";
		},
		error : function(data) {
...
<div id="deleteSalesOrder" title="Delete Sales Order"
	...
	<p>
		<spring:message
			code="BzComposer.nonprofit.pledgeboard.deletemessage" />
	</p>
...
<div id="warningDialog" title="Warning !" style="display: none;">
	<p>
		<spring:message
			code="BzComposer.nonprofit.pledgeboard.selectpledgewarning" />
	</p>
