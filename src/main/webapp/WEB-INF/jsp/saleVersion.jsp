      ...
      <div style="display:flex; gap:24px; align-items:center; flex-wrap:wrap;">
        <div style="flex:1 1 360px; min-width:280px;">
          ...
          <p style="margin:0 0 12px 0; font-size:16px; line-height:1.6; color:#334155;">
            A fast, reliable point-of-sale system that connects checkout, inventory, and accounting. Ideal for retail stores, pop-up shops, and service counters.
          </p>
          <p style="margin:0; font-size:16px; line-height:1.6; color:#334155;">
            The <span style="font-weight:600;">BzComposer POS Sale Program</span> integrates sales, inventory, and customer records, ensuring fast, reliable transactions with complete reporting.
          </p>
        ...
        <div style="flex:1 1 360px; min-width:280px;">
          <div style="background:#ffffff; border:1px solid #e5e7eb; border-radius:14px; padding:20px; box-shadow:0 6px 18px rgba(2,6,23,.08);">
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:12px;">
              <span style="font-weight:700; color:#111827;">POS Snapshot</span>
            ...
            <div style="display:flex; gap:12px; flex-wrap:wrap;">
              <div style="flex:1 1 120px; min-width:120px; background:#f0f4f8; border-radius:12px; padding:14px; text-align:center;">
                ...
                <div style="font-size:22px; font-weight:800; color:#1e40af;">276</div>
              </div>
              <div style="flex:1 1 120px; min-width:120px; background:#f0f4f8; border-radius:12px; padding:14px; text-align:center;">
                <div style="font-size:12px; color:#6b7280;">Active Counters</div>
                <div style="font-size:22px; font-weight:800; color:#1e40af;">8</div>
              </div>
              <div style="flex:1 1 120px; min-width:120px; background:#f0f4f8; border-radius:12px; padding:14px; text-align:center;">
                <div style="font-size:12px; color:#6b7280;">Customers</div>
                <div style="font-size:22px; font-weight:800; color:#1e40af;">152</div>
              </div>
            </div>
    ...
    <div style="max-width:1100px; margin:0 auto; padding:36px 16px;">
      ...
      <div style="display:flex; flex-wrap:wrap; gap:18px;">
        <div style="flex:1 1 260px; min-width:260px; background:#f8fafc; border-radius:14px; padding:18px; border:1px solid #e5e7eb; box-shadow:0 4px 18px rgba(2,6,23,.06); transition:0.3s;"
          ...
          <div style="font-weight:700; margin-bottom:8px;">Quick Checkout</div>
          <p style="margin:0; color:#334155; line-height:1.6;">Process sales quickly and reduce wait times with intuitive workflows.</p>
        </div>

        <div style="flex:1 1 260px; min-width:260px; background:#f8fafc; border-radius:14px; padding:18px; border:1px solid #e5e7eb; box-shadow:0 4px 18px rgba(2,6,23,.06); transition:0.3s;"
             onmouseover="this.style.boxShadow='0 8px 24px rgba(2,6,23,.12)';" onmouseout="this.style.boxShadow='0 4px 18px rgba(2,6,23,.06)';">
          <div style="font-weight:700; margin-bottom:8px;">Inventory Link</div>
          <p style="margin:0; color:#334155; line-height:1.6;">Every sale updates your inventory automatically in real time.</p>
        </div>

        <div style="flex:1 1 260px; min-width:260px; background:#f8fafc; border-radius:14px; padding:18px; border:1px solid #e5e7eb; box-shadow:0 4px 18px rgba(2,6,23,.06); transition:0.3s;"
             onmouseover="this.style.boxShadow='0 8px 24px rgba(2,6,23,.12)';" onmouseout="this.style.boxShadow='0 4px 18px rgba(2,6,23,.06)';">
          <div style="font-weight:700; margin-bottom:8px;">Multi-Payment Options</div>
          <p style="margin:0; color:#334155; line-height:1.6;">Accept cash, credit, debit, and digital wallet payments seamlessly.</p>
        </div>

        <div style="flex:1 1 260px; min-width:260px; background:#f8fafc; border-radius:14px; padding:18px; border:1px solid #e5e7eb; box-shadow:0 4px 18px rgba(2,6,23,.06); transition:0.3s;"
             onmouseover="this.style.boxShadow='0 8px 24px rgba(2,6,23,.12)';" onmouseout="this.style.boxShadow='0 4px 18px rgba(2,6,23,.06)';">
          <div style="font-weight:700; margin-bottom:8px;">Customer Data Capture</div>
          <p style="margin:0; color:#334155; line-height:1.6;">Collect customer info for loyalty programs and future promotions.</p>
        </div>

        <div style="flex:1 1 260px; min-width:260px; background:#f8fafc; border-radius:14px; padding:18px; border:1px solid #e5e7eb; box-shadow:0 4px 18px rgba(2,6,23,.06); transition:0.3s;"
             onmouseover="this.style.boxShadow='0 8px 24px rgba(2,6,23,.12)';" onmouseout="this.style.boxShadow='0 4px 18px rgba(2,6,23,.06)';">
          <div style="font-weight:700; margin-bottom:8px;">Sales Analytics</div>
          <p style="margin:0; color:#334155; line-height:1.6;">Generate detailed reports to track performance trends and sales insights.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="background:#f0f4f8; border-top:1px solid #e5e7eb; border-bottom:1px solid #e5e7eb;">
    <div style="max-width:1100px; margin:0 auto; padding:36px 16px;">
      ...
      <p style="margin:0; color:#334155; line-height:1.7;">
        Integrates with inventory, accounting, and CRM modules for complete retail and service connectivity.
      </p>
      <div style="display:flex; gap:12px; flex-wrap:wrap; margin-top:14px;">
        ...
        <span style="border:1px solid #e5e7eb; background:#ffffff; padding:8px 12px; border-radius:999px; font-size:12px;">POS Hardware</span>
      </div>
    </div>
  </section>
    ...
    <div style="max-width:1100px; margin:0 auto; padding:36px 16px;">
      ...
      <div style="display:flex; flex-wrap:wrap; gap:18px;">
        <div style="flex:1 1 320px; min-width:280px; background:#f8fafc; border-radius:14px; padding:18px; border:1px solid #e5e7eb; transition:0.3s;"
          ...
          <div style="font-weight:700; margin-bottom:6px;">Grocery Store</div>
          <p style="margin:0; color:#334155; line-height:1.6;">Tracks popular items for targeted promotions automatically.</p>
        </div>

        <div style="flex:1 1 320px; min-width:280px; background:#f8fafc; border-radius:14px; padding:18px; border:1px solid #e5e7eb; transition:0.3s;"
             onmouseover="this.style.boxShadow='0 8px 24px rgba(2,6,23,.12)';" onmouseout="this.style.boxShadow='0 0 0 rgba(0,0,0,0)';">
          <div style="font-weight:700; margin-bottom:6px;">Boutique</div>
          <p style="margin:0; color:#334155; line-height:1.6;">Automatically awards loyalty points at checkout for customers.</p>
        </div>

        <div style="flex:1 1 320px; min-width:280px; background:#f8fafc; border-radius:14px; padding:18px; border:1px solid #e5e7eb; transition:0.3s;"
             onmouseover="this.style.boxShadow='0 8px 24px rgba(2,6,23,.12)';" onmouseout="this.style.boxShadow='0 0 0 rgba(0,0,0,0)';">
          <div style="font-weight:700; margin-bottom:6px;">Pop-up Shop</div>
          <p style="margin:0; color:#334155; line-height:1.6;">Uses portable POS hardware synced with BzComposer for mobile sales.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="background:#f0f4f8; border-top:1px solid #e5e7eb;">
    <div style="max-width:1100px; margin:0 auto; padding:36px 16px; display:flex; flex-wrap:wrap; align-items:center; gap:20px;">
      <div style="flex:1 1 420px; min-width:280px;">
        <h3 style="margin:0 0 10px 0; font-size:24px; color:#1e40af;">Upgrade Your Checkout Experience</h3>
        <p style="margin:0; color:#334155; line-height:1.7;">
          Deliver faster service and better insights with the BzComposer POS Sale Program. Get started today.
        </p>
      </div>
