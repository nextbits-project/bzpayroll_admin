...
<html>
<title><spring:message code="BzComposer.companypagetitle"/></title>
...
{    
	...
	if(term.length>1)
	{
		...
		{
			var txt = $('#companyInfo').html().replace(highlightRe,'$1');
			
			if(term !== '') {
			        txt = txt.replace(new RegExp('(' + term + ')', 'gi'), highlightHtml);
			}    
			$("#companyInfo").html(txt);
			setTimeout(function(){ 
				document.getElementById("companyInfo").innerHTML = txt1;
			}, 5000);
		}	
	} 
	else
...
function openSampleCompany4()
{
	...
	<div id="companyInfo" class="container">
		<h2><spring:message code="BzComposer.company.company"/></h2>
	    <p class="para-temp "><b><spring:message code="BzComposer.company.companytextone"/></b></p>
	    
	    <p class="para-temp"><b><spring:message code="BzComposer.company.nextbits"/></b> 
	    <spring:message code="BzComposer.company.companytexttwo"/>
	    </p>
	    
	    <p class="para-temp">
	    	<spring:message code="BzComposer.company.companytextthree"/>
	    </p>
	    
	    <p class="para-temp">
	    	<spring:message code="BzComposer.company.companytextfour"/>
	    </p>
	    <p class="para-temp">
	    	<spring:message code="BzComposer.company.companytextfive"/>
	    </p>
	</div>
