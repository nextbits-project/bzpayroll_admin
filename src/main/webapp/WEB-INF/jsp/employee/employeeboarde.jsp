					...
					<table style="width: 100%;">
						<tr>
							<td style="font-size: 14px;">
								<table style="width: 100%;"class=" tabla-listados sortable dataTable no-foter customer-table">
									<tr>
										<td style="border: 1px solid #ccc; width: 300px; padding: 0; margin: 0; vertical-align:top">
											<table class="tabla-listados" cellspacing="0" style="border: 0;padding: 0; margin: 0;">
												<thead  class="sorting sorting_desc" tabindex="0" aria-controls="custTable" rowspan="1" colspan="1" aria=sort="descending" aria-label="ID:active to sort column ascending ">
												<!-- <tr valign="top"> -->
												<tr>
												...
												<tr>
													...
													<td colspan="4" style="margin: 0; padding:0;">
														...
														<div style="overflow: auto;height: 110vh; width:300px;">


															<table class="tabla-listados sortable dataTable no-foter customer-table">
										...
										<td style="font-size:14px; margin: 0; padding: 0;vertical-align: 0;">
											...
											<div id="table-negotiations" >
												<table cellspacing="0" class="tabla-listados " style="margin-top: 0; ">
													<thead>
													<tr>
