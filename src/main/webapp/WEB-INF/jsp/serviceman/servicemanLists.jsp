...
<title>BzComposer - Serviceman Lists</title>
<style>
.dataTables_length {
	font-size: 14px;
}
  ...
  $("#tabs").tabs({
    ...
    beforeActivate: function(event, ui) {
      ...
      if ($(ui.newTab).find("a").hasClass("tabs1")) {
        window.location.href = '/serviceman-lists';
        return false; // prevent jQuery UI from switching tab
      }
      if ($(ui.newTab).find("a").hasClass("tabs2")) {
        window.location.href = '/serviceman-inactive-employee-list';
        return false;
      }
    }
  });
							...
							<div style="width: 100%;">
								<table style="width: 100%;">
									...
									<tr>
										...
										<form action="searchEmployee" method="get" class="form-inline" style="flex-flow:row">
                                                                                               <input style="font-size: 12px; width: 150px;" type="text" name="name" placeholder="Name" class="form-control m-1" />
                                                                                                <input style="font-size: 12px; width: 150px;" type="text" name="address" placeholder="Address" class="form-control m-1" />
                                                                                                <input style="font-size: 12px; width: 150px;" type="text" name="city" placeholder="City" class="form-control m-1" />
                                                                                                <input style="font-size: 12px; width: 150px;" type="text" name="state" placeholder="State" class="form-control m-1" />
                                                                                                <input style="font-size: 12px; width: 150px;" type="text" name="zip" placeholder="Zip" class="form-control m-1" />
                                                                                                <input style="font-size: 12px; width: 150px;" type="text" name="phone" placeholder="Phone" class="form-control m-1" />
                                                                                                <input style="font-size: 12px; width: 150px;" type="text" name="email" placeholder="Email" class="form-control m-1" />

                                                                                                 <button type="submit" class="formButton" style="font-size: 13px; padding: 7 15px;">Go</button>
                                                                  </form>
											</td>
									</tr>
								</table>
...
function manageCustomer(cmd){
	...
	if (itemID == 0) {
		...
		if (cmd=="EDIT") {
			...
			window.open("/serviceman-edit-employee?employeeId="+itemID, null,"scrollbars=yes,height="+screen.height+",width=1300,status=yes,toolbar=no,menubar=no,location=no");
		}
		else if (cmd=="DELETE") {
			...
			$("#deleteCustomer").dialog({
		        ...
		        buttons: {
		            "<spring:message code='BzComposer.global.ok'/>": function () {
		                $(this).dialog("close");
		                window.location = "/serviceman-delete-employee/"+itemID;
		            },
...
function addNewCustomer(){
	...
	window.open("/serviceman-add-new-employee", null,"scrollbars=yes,height="+screen.height+",width=1300,status=yes,toolbar=no,menubar=no,location=no");
}
