...
<body style="margin:0; padding:0; font-family:Verdana, sans-serif; background:#eef2f7;">

    <div style="max-width:1100px; margin:40px auto; background:#fff; padding:40px;
                border-radius:12px; box-shadow:0 6px 16px rgba(0,0,0,0.12);">

        <!-- Title -->
        <div style="text-align:center; margin-bottom:30px;">
            <h2 style="font-size:28px; color:#004d80; margin:0;">Nonprofit Organization</h2>
            <p style="color:#666; font-size:14px; margin-top:8px;">BzComposer Nonprofit Program</p>
        </div>
        ...
        <div style="display:flex; gap:30px; flex-wrap:wrap;">
            ...
            <div style="flex:1; min-width:300px;">
                <p style="font-size:15px; line-height:1.7; color:#333;">
                    BzComposer’s nonprofit management software tracks donors, manages fundraising campaigns,
                    and ensures tax compliance — empowering charities, foundations, and nonprofit organizations
                    to focus on their mission.
                </p>
                <p style="font-size:15px; line-height:1.7; color:#333;">
                    Nonprofits need to focus on their mission — not just administration.
                    The <b>BzComposer Nonprofit Organization Program</b> makes it easier to manage donors,
                    track donations, and run fundraising campaigns.
                </p>

                <!-- Integration -->
                <div style="margin-top:20px; padding:15px; background:#f5fafc; border-left:4px solid #2196f3; border-radius:8px;">
                    <h3 style="color:#2196f3; margin:0 0 10px 0;">Integration & Compatibility</h3>
                    <p style="font-size:14px; color:#444; margin:0;">
                        Links with Accounting and CRM modules to keep nonprofit operations fully connected.
                    </p>
                </div>
            </div>
            ...
            <div style="flex:1; min-width:300px;">
                <!-- Features -->
                <div style="padding:15px; background:#fafcff; border-left:4px solid #4caf50; border-radius:8px;">
                    <h3 style="color:#4caf50; margin:0 0 12px 0;">Key Features & Benefits</h3>
                    <ul style="margin:0; padding-left:18px; color:#333; font-size:14px; line-height:1.8;">
                        <li><b>Donor Database:</b> Maintain detailed donor profiles with giving history.</li>
                        <li><b>Fundraising Campaign Management:</b> Plan, launch, and track donation campaigns.</li>
                        <li><b>Grant Tracking:</b> Manage grant applications, awards, and reporting.</li>
                        <li><b>Event Management:</b> Organize and track fundraising events.</li>
                        <li><b>Donation Reporting:</b> Generate reports for tax and compliance purposes.</li>
                    </ul>
                </div>

                <!-- Use Cases -->
                <div style="margin-top:20px; padding:15px; background:#fff9f3; border-left:4px solid #ff9800; border-radius:8px;">
                    <h3 style="color:#ff9800; margin:0 0 12px 0;">Use Case Examples</h3>
                    <ul style="margin:0; padding-left:18px; color:#333; font-size:14px; line-height:1.8;">
                        <li>A charity tracks recurring donations from monthly supporters.</li>
                        <li>A nonprofit runs a fundraising gala and records all ticket sales in BzComposer.</li>
                        <li>An organization tracks grant spending for compliance reporting.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <!-- Call to Action -->
        <div style="margin-top:40px; text-align:center; padding:25px; background:#004d80; border-radius:10px; color:#fff;">
            <h3 style="margin:0 0 10px 0;">Empower Your Mission</h3>
            <p style="font-size:14px; margin:0;">
                Let <b>BzComposer</b> handle the administration so you can focus on impact.
                <br>Contact us today for a nonprofit software demo.
            </p>
        </div>
