...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Hourly Calculator</h3>
        </div>
        <div class="card-body">
...
Also select whether this is an annual amount or if it is paid per pay period" data-field-type="DOLLAR"
                    ...
                    <div class="mb-3 row g-3"><label
                        ...
                        <div class="col-sm-9">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <div class="row g-3">
                                        <div class="boolean-label col-3 col-sm-4 text-end">FICA</div>
                ...
                <div class="col-12 text-center">
                    <button class="btn btn-primary calculate" style="width:20%" id="calculate-btn" type="submit">Calculate Tax</button>
                </div>
            </form>
            <div id="tax-result">
