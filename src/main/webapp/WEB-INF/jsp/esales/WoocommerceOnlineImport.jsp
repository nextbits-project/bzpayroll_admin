                ...
                <div id="blanquito">
                    <div id="padding">
                        <div class="container border p-4 rounded  bg-white">
                            <h3 style="margin-top: 0px;padding-bottom: 50px;">Woocommerce Online Import</h3>
...
<script>
    ...
    function onlineWoocommerceImportDialog(){
        $("#onlineWoocommerceImportDialog").dialog({
            resizable: false,
            height: 470,
            width: 860,
            modal: true,
...
<div id="onlineWoocommerceImportDialog" style="display:none;">
   <div class="main-container">

    <div class="section">
        <p class="mb-1 text-dark fw-bold">Processing eSales records from :
        <span class="">Woocommerce[Woocommerce Online Import]</span>
        </p>
