                ...
                <div id="blanquito">
                    <div id="padding">
                        <div class="container border p-4 rounded  bg-white">
                            <h3 style="margin-top: 0px;padding-bottom: 50px;">Amazon Seller Online Import V.3.0</h3>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-muted small">
                                    Note: Select the store from where eSales order will be imported.
                                    Please provide the Access Key, Secret Key, Merchant ID, and
                                    Market PlaceID while setting up the store. <br>
                                    Click on the Online Amazon Import button to import the eSales
                                    order from selected store.
                                </p>
                            </div>

                            <div class="d-flex justify-content-end gap-2">
                                <button class="btn btn-primary" onclick="onlineAmazonImportDialog()">On Line Amazon Import</button>
...
<div id="onlineAmazonImportDialog" style="display:none;">
   <div class="main-container">
    <div class="section bg-light">
        <strong>Amazon Seller</strong><br>
        <span> <span id="storeNameData">${defaultStore.storeName}</span> : Store settings not available</span><br><br>
        <span>Total Imported Orders: <strong>0</strong></span><br>
        <span>Total Duplicate Orders: <strong>0</strong></span>
    </div>

    <div class="section">
        <p class="mb-1 text-dark fw-bold">Importing eSales Orders from :
        <span class="text-primary">Import Completed</span>
        </p>
        <p class="mb-1 text-dark">Successfully Imported Orders: <strong>0</strong></p>
