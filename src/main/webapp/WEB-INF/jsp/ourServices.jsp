...
<title><spring:message code="BzComposer.ourservicetitle"/></title>
...
<body>
		...
		<div class="header header-1">
			<div class="container">
				...
				<div style="text-align: -webkit-center;">
					<input type="text" id="searchBoxNR" name="searchBoxNR" placeholder="<spring:message code="BzComposer.searchtext"/>" style="width: 241px" />
					<button class="btn btn-primary" onclick="searchTextNotResponsive()"><spring:message code="BzComposer.searchbuttontext"/></button>
				</div>
			</div>
		</div>
	</div>
	...
	<h2><spring:message code="BzComposer.service.ourservice"/></h2>
	
	<div class="para-temp">
		<h4 style="float: left; width: 100%;">
			<b><spring:message code="BzComposer.service.customization"/></b></h4>
		<spring:message code="BzComposer.service.customizationcontent"/>
	</div>
	
	<div class="para-temp">
		<h4 style="float: left; width: 100%;">
			<b><spring:message code="BzComposer.service.localization"/>
			</b>
		</h4>
		<spring:message code="BzComposer.service.localizationcontent"/>
	 </div>
	 
	 <div class="para-temp">
	 	<h4 style="float: left; width: 100%;">
	 		<b><spring:message code="BzComposer.service.customerservice"/>
	 	</b>
 		</h4>
 		<spring:message code="BzComposer.service.customerservicecontent"/>
	 </div>
	</div>
