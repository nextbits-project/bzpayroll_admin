...
<title><spring:message code="BzComposer.configuration.eCommerce" /></title>
...
<body>
                     <div align="center">
                                           <img src="/ConfigurationImages/E_commerce.png" height="60" width="60">
                                            <span
																				style="font-size: 1.6em; font-weight: bold; color:#05A9C5;; margin: 30px 30px 30px 30px;  padding: 0 0 .3em 0;">
																				<spring:message
																					code="BzComposer.configuration.eCommerce" />
											</span>
                                            </div>
                                            <br>
