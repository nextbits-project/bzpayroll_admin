...
<body>
	...
	<div id="existingCompetitors" class="container">
		<h2><spring:message code="BzComposer.existingcompetitors.competitors"/></h2>
		<div class="para-temp">
	   		<h4 style="float: left; width: 100%;"><b><spring:message code="BzComposer.existingcometitors.maincompetitors"/></b></h4>
	   		<ol>
			  <li><spring:message code="BzComposer.existingcometitors.oracle"/></li>
			  <li><spring:message code="BzComposer.existingcometitors.sap"/></li>
			  <li><spring:message code="BzComposer.existingcometitors.microsoft"/></li>
			  <li><spring:message code="BzComposer.existingcometitors.saggroup"/></li>
			  <li><spring:message code="BzComposer.existingcometitors.epicor"/></li>
			  <li><spring:message code="BzComposer.existingcometitors.quickbooks"/></li>
		</ol>
		<spring:message code="BzComposer.existingcometitors.competitorscontent"/>   
	   </div>
	</div>
