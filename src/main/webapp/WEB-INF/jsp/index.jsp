...
<title><spring:message code="BzComposer.homepagetitle"/></title>
 <!-- CSS FIRST -->
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/includeAll/jquery.dataTables.min.css"/>
...
function showLocale(){
	...
	window.location = "/changeLocale?requestPage=HomePage&lang="+lang;
}
