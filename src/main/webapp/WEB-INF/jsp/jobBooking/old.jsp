                                ...
                                <tr>
                                    <td style="width: 20%;">
                                        <div style="padding-bottom: 5px;padding-top: 10px;">
                                            ...
                                            <div id="callInfo" style="display: none;">Waiting for call...</div>
                                        </div>
                                    </td>
                                    <td style="width: 80%;">
										...
										<table style="padding: 0; width: 100%; margin-top: 10px;"
											...
											<tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td colspan="4"><form:radiobutton
                                                                                        ...
                                                                                        <script type="text/javascript"> radio_val = document.CustomerForm.dispay_info.value;</script></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td><form:radiobutton
												...
												<td colspan="10" style="vertical-align: 0; display: none;">
													...
													<!-- =============== Technician Details  ================ -->
													<input type="hidden" name="tlistSize" id="tSize"
													value='${bcaTechnicianList.size()}' />
													<table class="tabla-listados" cellspacing="0"
														style="margin-top: 0; margin-left: 20px;">
														<thead>
															<tr>
																<th style="font-size: 14px;"><spring:message
																		code="BzComposer.technicianinfo.techniciandetails" />
																</th>
															</tr>
														</thead>
														<tbody>
																		...
																		<thead>
																			<tr valign="center">
																				<th style="padding-right: 30px !important;"><spring:message
																						code="BzComposer.technicianinfo.technicianid" /></th>
																				<th><spring:message
																						code="BzComposer.technicianinfo.name" /></th>
																				<th><spring:message
																						code="BzComposer.technicianinfo.phone" /></th>
																				<th><spring:message
																						code="BzComposer.technicianinfo.email" /></th>
																				<th><spring:message
																						code="BzComposer.technicianinfo.specialization" /></th>
																			</tr>
																		</thead>
																		<tbody id="technicianTableBody">
																			<c:if test="${not empty bcaTechnicianList}">
																				<c:forEach items="${bcaTechnicianList}"
																					var="objList" varStatus="loop">
																					<tr id='${loop.index}technician$$'
																						onclick="setRowIdCase(${objList.technicianID}, ${loop.index}, true);">
																						<td><input type="checkbox"
																							id="technicianID${loop.index}"
																							value="${objList.technicianID}"
																							onchange="addRowTechnicianIndex(${loop.index}, ${objList.technicianID})" />
																							${objList.technicianID}</td>
																						<td>${objList.name}</td>
																						<td>${objList.phone}</td>
																						<td>${objList.email}</td>
																						<td>${objList.specialization}</td>
