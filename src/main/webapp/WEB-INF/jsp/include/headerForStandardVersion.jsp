...
<link href="${pageContext.request.contextPath}/styles/basic.css" media="screen" rel="Stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/styles/formitems.css" media="screen" rel="Stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/styles/menu.css" media="screen" rel="Stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/styles/diveffects.css" media="screen" rel="Stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/styles/calendar.css" rel="stylesheet" />
<link href="${pageContext.request.contextPath}/styles/textareas.css" media="screen" rel="Stylesheet" type="text/css" />
...
<!-- Menu Style CSS And Css222 -->
<link href="${pageContext.request.contextPath}/dist/css/superfish.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${pageContext.request.contextPath}/dist/css/superfish-navbar.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${pageContext.request.contextPath}/dist/css/superfish-vertical.css" rel="stylesheet" type="text/css" media="screen"/>
...
<!-- Date 18-10-2018 for datatable export -->
...
<script src="${pageContext.request.contextPath}/scripts/effects.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/dragdrop.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/controls.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/application.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/validator.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/message.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/calendar.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/diveffects.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/tabs.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/sortable.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/epoch_classes.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/scripts/timesheet.js" type="text/javascript"></script>
...
<%-- <link href="${pageContext.request.contextPath}/inputstyle/bootstrap-select.js" rel="stylesheet" type="text/css" /> --%>
...
<script src="${pageContext.request.contextPath}/dist/js/superfish.min.js" type="text/javascript"></script>
...
<script src="${pageContext.request.contextPath}/dist/jsPdf/jspdf.js" type="text/javascript"></script>
<%-- <script src="${pageContext.request.contextPath}/dist/jsPdf/jspdf.min.js" type="text/javascript"></script> --%>
<script src="${pageContext.request.contextPath}/dist/jsPdf/split_text_to_size.js" type="text/javascript"></script>
