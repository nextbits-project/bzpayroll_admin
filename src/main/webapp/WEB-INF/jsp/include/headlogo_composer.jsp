...
<div class="bzclogo" style="float:left;">
	<a href="${pageContext.request.contextPath}/Dashboard?tabid=Dashboard">
        <img src = "/images/bzpayroll-logo.jpg" width="289" height="75"  style="margin-left: 30px;" alt="bzpayroll"/>
</a>
</div>
<br>
...
<%=  (String)session.getAttribute("user") %> <spring:message code="BzComposer.register.with"/> <%= (String)session.getAttribute("membershipLevel") %> <spring:message code="BzComposer.register.membershiplabel"/> 
	</div>
	<!-- <div class="horizontal"> 
