			...
			<nav class="navbar navbar-expand-lg top-app-navbar">
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="fileDropDown">
								...
								<li class="dropdown-submenu">
									...
									<ul class="dropdown-menu">
										<li>
											<a class="dropdown-item" href="" onclick="employeeExportData()">
												Employees
											</a>
										</li>
									</ul>
                   ...
                   <ul class="dropdown-menu">
					...
					<!-- Settings Menu Trigger -->
					<li class="nav-item dropdown" id="settingsTrigger">
						<a class="nav-link dropdown-toggle" href="#" id="settingsToggle" role="button"
							data-toggle="dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">SETTINGS</a>
						<div class="dropdown-menu" aria-labelledby="settingsToggle">
							<a class="dropdown-item" href="/settings/general">General</a>
							<a class="dropdown-item" href="/settings/employee">Employee</a>
							<a class="dropdown-item" href="/settings/taxes?type=federalTax">Federal Tax</a>
							<a class="dropdown-item" href="/settings/state-tax?type=stateTax">State Tax</a>
						</div>
					</li>
					<!-- About-->
					<li class="nav-item dropdown">
