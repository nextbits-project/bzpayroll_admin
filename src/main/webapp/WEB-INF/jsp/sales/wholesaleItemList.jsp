                ...
                <div id="padding">
                    ...
                    <div>
                        <div style="float: left;">
								<span
									...
									<spring:message code="BzComposer.wholesale.wholesaleTemplateList"/> <c:if
                                    ...
                                    <td colspan="6">
                                        <div>
                                        	<input type="button" class="formbutton"
                                                   onclick="addAssemblyProducts();" style="padding: 7 15px;"
                                                   value="<spring:message code='BzComposer.wholesale.assemblyProducts.add'/>"/>
                                            <input type="button" class="formbutton"
                                                   onclick="addNewItem();" style="padding: 7 15px;"
                                                   value="<spring:message code='BzComposer.wholesale.assemblyTemplate.add'/>"/>
                                            <input type="button" class="formbutton"
                    ...
                    <table id="custTable" class="tabla-listados sortable devItemList"
                        ...
                        <tr valign="top">
                            ...
                            <th align="center"><spring:message
                                    code="BzComposer.wholesale.itemcode"/></th>
...
<script>
    ...
    function manageItem(cmd) {
        ...
        if (cmd == "EDIT") {
            ...
            window.open("Item?tabid=EditAssemblyProduct&InvId=" + itemID, null, "scrollbars=yes,height=1000,width=1620,status=yes,toolbar=no,menubar=no,location=no");
        } else if (cmd == "DELETE") {
            ...
            $("#deleteCustomer").dialog({
                ...
                buttons: {
                    "<spring:message code='BzComposer.global.ok'/>": function () {
                        ...
                        window.location = "Item?tabid=AssemblyProductDelete&InvId=" + itemID;
                    },
	...
	function addAssemblyProducts() {
        window.open("Item?tabid=AssemblyProductsAdd&ItemType=1", null, "scrollbars=yes,height=1000,width=1620,status=yes,toolbar=no,menubar=no,location=no");
    }
