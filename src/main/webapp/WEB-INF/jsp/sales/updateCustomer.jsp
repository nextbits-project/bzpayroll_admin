			...
			<div class="statusquo ok">
				<div id="hoja">
								...
								<div id="tabs" style="min-height: 550px; width: 100%;">
									<ul>
										<li><a href="#General-1"><spring:message
													code="BzComposer.updatecustomer.tabs.general" /></a></li>
										...
										<li><a href="#finance-5"><spring:message
													code="BzComposer.updatecustomer.tabs.financecharges" /></a></li>
										<li><a href="#Transactional-6"><spring:message
										...
										<div id="content1" class="tabPage">
											...
											<div id="table-negotiations">
												<table class="tabla-listados" cellspacing="0" width="100%">
													<thead>
														<tr>
															<th colspan="7" style="font-size: 14px;"><spring:message
																	code="BzComposer.updatecustomer.customerinformation" />
															</th>
														</tr>
													</thead>
													<tbody>
															...
															<td colspan="5">
																<table style="width: 100%;">
																	<tr>
																		...
																		<td><form:input path="middleName" size="15" /></td>
																		<td><spring:message
														...
														<tr>
															<td><spring:message code="BzComposer.global.company" />
																<span class="inputHighlighted"><spring:message
																		code="BzComposer.CompulsoryField.Validation" /></span></td>
															<td colspan="3"><form:input path="cname"
																	style="width:90%;" /></td>
															<td><spring:message
														...
														<tr>
															<td><spring:message
																	code="BzComposer.global.address1" /> <span
																class="inputHighlighted"><spring:message
																		code="BzComposer.CompulsoryField.Validation" /></span></td>
														...
														<tr>
															...
															<td><spring:message
																	code="BzComposer.global.homepage" /></td>
														...
														<tr>
															<td><spring:message
																	code="BzComposer.customer.CustomerType" /></td>
															...
															<td><spring:message
                                                        code="BzComposer.customer.CustomerSource"/></td>
                                                <td><form:select path="customerGroup">
                                                    ...
                                                    <form:options items="${customerGroupList}"
															...
															<td><c:if test="${CustomerDetails.taxAble == 1}">
																	<input value="on" type="checkbox" name="isTaxable"
																		checked="checked" />
																</c:if> <c:if test="${CustomerDetails.taxAble != 1}">
																	<input value="on" type="checkbox" name="isTaxable" />
																</c:if> <spring:message code="BzComposer.global.istaxable" />
															</td>
															<td><c:if test="${CustomerDetails.isclient == '1'}">
																	<input value="on" type="checkbox" name="isAlsoClient"
																		checked="checked">
																</c:if> <c:if test="${CustomerDetails.isclient != '1'}">
																	<input value="on" type="checkbox" name="isAlsoClient">
																</c:if> <spring:message code="BzComposer.global.isalsovendor" />
															</td>
															<td>&nbsp;</td>
														</tr>
														<tr>
													...
													<thead>
														<tr>
															<th colspan="6" style="font-size: 14px;"><spring:message
																	code="BzComposer.updatecustomer.prefrenceinfo" /></th>
														</tr>
													</thead>
													<tbody>
														<tr>
											...
											<div id="table-negotiations">
												<table align="center" style="width: 100%"
													...
													<thead>
														<tr>
															<th colspan="4" style="font-size: 14px;"><spring:message
													...
													<tr>
														<td>
															<table class="tabla-listados" cellspacing="0" width="200"
																...
																<thead>
																	<tr>
																		<th colspan="5" style="font-size: 14px;"><spring:message
																				code="BzComposer.updatecustomer.billingaddress" /></th>
																	</tr>
																</thead>
																<tbody>
																	<tr>
																		<td><spring:message
																				code="BzComposer.global.company" /><span
																			class="inputHighlighted"><spring:message
																					code="BzComposer.CompulsoryField.Validation" /></span></td>
																	...
																	<tr>
																		<td><spring:message
																				code="BzComposer.register.dbaName" /></td>
																		<td colspan="2"><form:input path="bsdbaName" />
																		</td>
																		<td colspan="2">&nbsp;</td>
																	</tr>
																	<tr>
																		<td colspan="1"><spring:message
																				code="BzComposer.global.firstname" /> <span
																			class="inputHighlighted"><spring:message
																					code="BzComposer.CompulsoryField.Validation" /></span></td>
																	...
																	<tr>
																		<td colspan="5" align="center">
																			<button type="button" class="formbutton"
																				...
																				<spring:message
																					code='BzComposer.updatecustomer.clearbillingaddress' />
																			</button>
																		</td>
																	</tr>
																</tbody>
														...
														<td style="vertical-align: inherit; font-size: 14px;">
															...
															value="<spring:message code='BzComposer.updatecustomer.copyto'/>"
															title="Copy Address">
														</td>
														<td>
															<table class="tabla-listados" cellspacing="0" width="200"
																...
																<thead>
																	<tr>
																		<th colspan="5" style="font-size: 14px;"><spring:message
																				code="BzComposer.updatecustomer.shippingaddress" />
																		</th>
																	</tr>
																</thead>
																<tbody>
																	...
																	<tr>
																		<td><spring:message
																				code="BzComposer.register.dbaName" /></td>
																		<td colspan="2"><form:input path="shdbaName" />
																		</td>
																		<td colspan="2">&nbsp;</td>
																	</tr>
																	<tr>
																	...
																	<tr align="center">
																		<td colspan="5">
																			<button type="button" class="formbutton"
																				name="ClearShippingBtn"
																				onclick="clearShippingAdd();"
																				title="Clear Shipping Address">
																				<spring:message
																					code='BzComposer.updatecustomer.clearshippingaddress' />
																			</button>
																		</td>
																	</tr>
																</tbody>
											...
											<div id="table-negotiations">
												<table class="tabla-listados" cellspacing="0">
													<thead>
														<tr>
															<th colspan="4" style="font-size: 14px;"><spring:message
																	code="BzComposer.updatecustomer.financemsg" /></th>
														</tr>
													</thead>
													<thead>
														<tr>
																	...
																	<div id="table-negotiations"
																		...
																		<table class="tabla-listados" cellspacing="0">
																			<thead>
																				<tr>
																					<th colspan="4" style="font-size: 14px;"><spring:message
																							code="BzComposer.updatecustomer.chargerate" /></th>
																				</tr>
																			</thead>
																			<tbody>
																				<tr>
																					<td><spring:message
																							code="BzComposer.updatecustomer.annualintrestrate" />
																					</td>
																				...
																				<tr>
																					<td><spring:message
																							code="BzComposer.updatecustomer.minimumfinanacecharge" />
																					</td>
																					<td colspan="3"><form:input
																							onkeypress="return numbersonly(event,this.value)"
																				...
																				<tr>
																					<td><spring:message
																							code="BzComposer.updatecustomer.graceperiod" />
																					</td>
																					<td colspan="3"><form:input
																							onkeypress="return numbersonly(event,this.value)"
																	...
																	<div id="table-negotiations"
																		...
																		<table class="tabla-listados" cellspacing="0">
																			<thead>
																				<tr>
																					<th colspan="4" style="font-size: 14px;"><spring:message
																							code="BzComposer.updatecustomer.applyingcharges" />
																					</th>
																				</tr>
																			</thead>
																			<tbody>
					...
					for (i=0; i<exist.length; i++){
						exist[i]=-1;
											...
											<div id="table-negotiations">
												<table class="tabla-listados" cellspacing="0">
													<thead>
														<tr>
															<th colspan="5" style="font-size: 14px;"><spring:message
																	code="BzComposer.updatecustomer.creditcardinfo" /></th>
														</tr>
													</thead>
													<tbody>
														<!-- <tr>
															...
															<td colspan="5">
																<div class="container text-center">
																	<div class="row text-left" id="customerCards">
																		<c:forEach items="${CustomerDetails.customerCards}"
																			var="objList">
																			<div class="col-sm-4">
																						...
																						<c:choose>
																							...
																							<c:otherwise>
																								<p class="card-text float-right">
																									<a
																										href="Customer?tabid=makeCustomerCardDefault2&cvId=${objList.clientVendorID}&cardID=${objList.cardID}"
																										style="color: #007bff;"> <strong><spring:message
																				...
																				<div class="card-body">
																					<a href="#" onclick="showAddPaymentMethodDialog();">
																						<h6 class="card-subtitle text-center"
																							style="margin-top: 40px; color: #05A9C5 !important;">
																							<spring:message
																								code="BzComposer.banking.addPaymentMethod" />
																						</h6>
																					</a>
																				</div>
																			</div>
										...
										<div id="content3" class="tabPage">
											...
											<div id="table-negotiations" style="width: 100%">
												...
												<table class="tabla-listados" cellspacing="0">
													...
													<tr>
														<td><spring:message
																code="BzComposer.updatecustomer.service" /></td>
														<td><form:select path="serviceID">
																<form:options items="${ServiceList}"
																	itemValue="serviceID" itemLabel="serviceName" />
															</form:select></td>
													...
													<tr>
														<td colspan="6"><spring:message
																code="BzComposer.updatecustomer.selectedservice" /></td>
													</tr>
													</tbody>
												</table>
												<div>
													...
													<table class="tabla-listados" cellspacing="0">
														<thead>
															<tr>
																<th><spring:message
																		code="BzComposer.updatecustomer.servicename" /></th>
																<th><spring:message
																		code="BzComposer.updatecustomer.invoicestyle" /></th>
																<th align="center"><spring:message
																		code="BzComposer.updatecustomer.balance" /></th>
																<th align="center"><spring:message
																		code="BzComposer.updatecustomer.default" /></th>
																<th align="center"><spring:message
																		code="BzComposer.updatecustomer.remove" /></th>
															</tr>
														</thead>
														<tr id="tr$$">
															<td align="center"></td>
                                    ...
                                    $('#default_sid').val(${DefaultService});
										...
										$('#default_sid').val(0);
															...
															<c:if test="${not empty ServiceInfo}">
																<input type="text" name="serviceSize" id="sIDSize"
																	value='${ServiceInfo.size()}' />
											...
											<div id="table-negotiations">
												<table class="tabla-listados" cellspacing="0">
													<thead>
														<tr>
															<th colspan="4" style="font-size: 14px;"><spring:message
																	code="BzComposer.updatecustomer.displayoption" /></th>
														</tr>
													</thead>
													<tr>
														<td colspan="4"><form:radiobutton path="dispay_info"
																value="ShowAll" onclick="hide_details(this.value);" />
                                    ...
                                    radio_val = document.CustomerForm.dispay_info.value;
													...
													<tr>
														<td><form:radiobutton path="dispay_info"
																value="ByVal" onclick="hide_details(this.value);" /> <spring:message
						...
						<div>
							<input type="hidden" name="AnualRate" id="arate"> <input
								type="hidden" name="MinFinance" id="mfinance"> <input
								type="hidden" name="GracePeriod" id="gperiod" /> <input
								type="hidden" name="Flag" id="flagId" value="0" /> <input
...
function initialize(){
	...
	var selectedCustomerGroupID = '<%=request.getAttribute("selectedCustomerGroupID")%>';
	...
	$('select[id="customerGroup"]').find('option[value="'+selectedCustomerGroupID+'"]').attr("selected",true);
...
<div id="showNameDialog" style="display: none;">
	<p>
		<spring:message code="BzComposer.updatecustomer.entercompanyname" />
	</p>
</div>
<div id="showFirstNameDialog" style="display: none;">
	<p>
		<spring:message code="BzComposer.updatecustomer.enterfirstname" />
	</p>
</div>
<div id="showLastNameDialog" style="display: none;">
	<p>
		<spring:message code="BzComposer.updatecustomer.enterlastname" />
	</p>
</div>
<div id="showAddress1Dialog" style="display: none;">
	<p>
		<spring:message code="BzComposer.updatecustomer.enteradderss1" />
	</p>
</div>
<div id="showCityDialog" style="display: none;">
	<p>
		<spring:message code="BzComposer.updatecustomer.entercity" />
	</p>
</div>
<div id="showZipCodeDialog" style="display: none;">
	<p>
		<spring:message code="BzComposer.updatecustomer.enterzipcode" />
	</p>
</div>
<div id="showEmailValidationDialog" style="display: none;">
	<p>
		<spring:message code="BzComposer.updatevendor.enteremailvalidation" />
	</p>
</div>
...
<div id="showCellPhoneDialog" style="display: none;">
	<p>
		<spring:message
			code="BzComposer.updatecustomer.cellphonenumberistoolarge" />
	</p>
</div>
<div id="showServiceValidationDialog" style="display: none;">
	<p>
		<spring:message code="BzComposer.updatecustomer.serviceexist" />
	</p>
</div>
<div id="showselectitemdialog" style="display: none;">
	<p>
		<spring:message code="BzComposer.updatecustomer.selectitemfirst" />
	</p>
</div>
		...
		<form name="CardForm" method="post">
			<table class="tabla-listados" cellspacing="0">
				...
				<tbody>
					...
					<tr>
						<td>&nbsp;<spring:message code="BzComposer.global.expdate" /></td>
						<td><input id="expDate" name="expDate" readonly="true" /> <img
							src="images/cal.gif"
							onclick="displayCalendar(document.CardForm.expDate, 'mm/yyyy', this);">
							<spring:message code="BzComposer.Customer.mformate" /></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;<spring:message code="BzComposer.global.CW2" /></td>
					...
					<tr>
						<td>&nbsp;<spring:message
								code="BzComposer.updatecustomer.billingaddress" /></td>
						<td><input id="cardBillAddress" size="30" /></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;<spring:message code="BzComposer.global.zipcode" /></td>
						<td><input onkeypress="return numbersonly(event,this.value)"
							id="cardZip" /></td>
						<td>&nbsp;</td>
					</tr>
				</tbody>
