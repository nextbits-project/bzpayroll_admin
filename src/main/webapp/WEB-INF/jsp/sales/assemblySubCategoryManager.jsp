						...
						<div>
							<div>
								<span
									...
									<spring:message code="BzComposer.wholesale.sub.assemblycategorymanager" /> <c:if
...
<div class="container-fluid" id="AddEditItemDlg">
	<div class="table-responsive" style="padding:10 20px;font-size: 14px;border: 1px solid #ced4da;border-radius: .25rem;min-height: 220px">
         ...
         <hr/>
	     <form:form action="/AssemblyCategoryManager?tabid=SaveAssemblySubCategoryManager" method="post" onsubmit="return validateAddItemForm(this);" modelAttribute="itemCategoryDto">
	        <div class="row">
         ...
         $("#deletedialogbox").dialog({
        	    ...
        	    buttons: {
        	        "<spring:message code='BzComposer.global.ok' />": function () {
        	            ...
        	            var redirectURL = "AssemblyCategoryManager?tabid=DeleteAssemblySubCategoryManager&itemId=" + selectedRowIndexs;
...
function BackButton(){
	var redirectURL = "AssemblyCategoryManager?tabid=List";
	window.location = redirectURL;
}
