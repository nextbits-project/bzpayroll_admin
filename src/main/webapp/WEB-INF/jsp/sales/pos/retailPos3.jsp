...
<div class="container-fluid" style="padding-bottom: 60px;">
    <div class="row">
        <div class="col-md-6">
            <div class="column-right" style="height: 110vh;">
        ...
        <div class="col-md-6">
            <div class="column-lef" style="height: 110vh;">
                <div class="left-top">
                ...
                <div class="row" style="border-top: 1px solid">
                    <div class="col-sm-6" style="padding: 0px;">
                        <form name="sci-calc">
                            <center>
                                <table class="calculator" cellspacing="0" cellpadding="1" style="margin-top: 5px;">
                                    <tr>
                    ...
                    <div class="col-sm-6">
                        <div class="left-bottom">
                            <div class="summary">
                                <div class="summary-group" style="display: block;">
