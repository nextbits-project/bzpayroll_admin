...
document.forms["OpportunityForm"].action ="Customer?tabid=updateCustomerOpportunity&cvID="+cvid;
						...
						<div id="padding">
							...
							<div>
								<span
									...
									<spring:message code="BzComposer.customer.editOpportunity" />
								</span>
							</div>
...
<div>
				...
				<tr>
					<td align="center">
						...
						<button type="button" class="formbutton" title="Save Opportunity" onclick="updateOpportunity()"><spring:message code='BzComposer.global.save'/></button>
