...
<title><spring:message code="BzComposer.addnewcustomer.addcontacttitle" /></title>
...
<div id="padding">
	...
	<div>
		<span style="font-size: 1.2em; font-weight: normal; color: #838383; margin: 10px 0px 5px 0px; border-bottom: 1px dotted #333; padding: 0 0 .1em 0;">
