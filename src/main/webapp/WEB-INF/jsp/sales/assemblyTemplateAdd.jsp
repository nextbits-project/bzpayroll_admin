...
<div>
	<span style="font-size:1.2em;font-weight:normal;color:#838383;margin:30px 0px 15px 0px;border-bottom:1px dotted #333;padding:0 0 .3em 0;">
		<spring:message code="BzComposer.wholesale.assembly.template"/>
				...
				$("#showItemDialog").dialog({
                    ...
                    buttons: {
                        "<spring:message code='BzComposer.global.ok'/>": function () {
                            ...
                            document.forms['AddItemfrm'].action = "Item?tabid=SaveAssemblyTemplate&selectedItems=" + encodeURIComponent(JSON.stringify(selectedItems));
                            document.forms['AddItemfrm'].submit();
                            //$('form').submit();
                        },
                        <spring:message code='BzComposer.global.cancel'/>: function () {
