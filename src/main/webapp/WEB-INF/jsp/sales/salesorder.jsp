													...
													<table>
														<tr>
															<td id="bill_id" style="font-size: 14px;"><spring:message
																	...
																	id="billTo" oninput="EditBillingAddressPage(this.form);"
													...
													<table>
														<tr>
															<td id="ship_id"
																...
																<br /> <form:textarea path="shipTo" id="shipTo"  rows="6" cols="25"
												...
												<c:if test="${not empty Cart}">
													...
													<c:forEach items="${Cart}" var="cart" varStatus="loop">
														<tr id='${loop.index}row'>
															...
															<td align="left" style="font-size: 14px;">
																<div id='${loop.index}iserial'>${cartskyoe
																.serialNo}</div>
															</td>
															<td align="left" style="font-size: 14px;">
        ...
        buttons: {
            "<spring:message code='BzComposer.global.ok'/>": function () {
				...
				$.ajax({
					...
					data: {type:"SalesOrder", orderNo: orderNo},
					success: function (data) {
