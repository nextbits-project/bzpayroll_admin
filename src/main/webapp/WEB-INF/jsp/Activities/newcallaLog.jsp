...
<form:form name="TaskForm" method="post" id="frmNewCustomer" modelAttribute="logCallDto">
    ...
    <div id="cos">
		...
		<span style="font-size: 1.2em; font-weight: normal; color: #838383; margin: 30px 0px 15px 0px; border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
			<spring:message code="BzComposer.crmCustomer.logaCall.new"/>
		</span>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <div id="table-negotiations">
                                        ...
                                        <td >
                                                 ...
                                                 <td><form:input path="relatedTo" style="width:150px"/></td>
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <button type="button" class="formbutton" title="Save Task"
                                            onclick="saveCallaLog();"><spring:message
...
<script>
    ...
    function saveCallaLog()
    {
	 ...
	 $.ajax({
	 		type : "POST",
	 		url : "manageActivity?tabid=saveLogaCall",
	 	    data :"data="+ obj,
