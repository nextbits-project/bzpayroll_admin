...
<div><%--Tax Body start--%>
    ...
    <div id="table-negotiations" style="padding: 0; border: 1px solid #ccc;"><%--Configuration tab border start--%>
            <span style="font-size:30px;cursor:pointer; margin-right: 20px; float:right" onclick="toggleFunction()">&#9776;</span>
            <table cellspacing="0"  style="border: 0;width: 100%;overflow-y:scroll;" class="section-border">
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <script>
                          $(document).ready(function() {
                                                        // Simulate a click on the second tab (stateTax)
                                                        $("a[href='#stateTax']").click();
                                                    });
                          </script>
