...
<style type="text/css">
.plan-amount-details{
  height: 80px;background-color: #05A9C5 ;padding-top: 10px;
  padding-bottom: 10px;
 font-weight: bold;
}
...
<body>
	...
	<div>
		<span style="font-size: 1.1em; font-weight: normal; color: #838383; margin: 30px 0px 15px 0px; border-bottom: 1px dotted #333; padding: 0 0 .3em 0;">
			<spring:message code="BzComposer.configuration.version&membership"/>
		</span></div>
	<div>
	...
	<table cellspacing="0"  style="border: 0;width: 100%;overflow-y:scroll;" class="section-border">
		...
		<tr>
			...
			<table>
				<tr><td><jsp:include page="versionMembershipMenuPage.jsp" /></td></tr>
			</table>
			</td>
			<td valign="top" >
				...
				<table class="table-notifications" width="100%">
                    ...
                    <tr>
                        <td align="center" colspan="2" style="font-size: 12px; padding: 20px;">
                            <h2>
                            <spring:message code="BzComposer.membership.Hereareyour"/> <%= (String)session.getAttribute("membershipLevel") %> 
                        ...
                        <div class="col-sm-3 mb-3">
                            <div class="card">
                                ...
                                <div class="plan-details text-center">
                                  <h3 style="color: #337ab7;font-size: 1.3rem;font-weight: bold"><spring:message code="BzComposer.membership.freeTrial"/>
                                  </h3>    <br/>
                                  ...
                                  <div class="pricing-btn" disabled="true" ><button type="button" class="paypal-btn"></button></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
