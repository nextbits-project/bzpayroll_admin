                                ...
                                <div id="table-negotiations" style="padding: 0; border: 1px solid #ccc; margin-top: 15px;">
                                    <table cellspacing="0" style="border: 0; padding: 0; width: 100%;overflow-y:scroll;" class="">
                                        ...
                                        <td id="leftMenu" style="position: relative; width: 180px; vertical-align: top;">
                                            <div style="display: flex; justify-content: flex-start; align-items: flex-start; width: 180px;">
                                                <table>
                                                    <tr>
                                        ...
                                        <td valign="top">
                                            ...
                                            <div id="general" style="padding: 0; position: relative; left: 0;">
                                                <div id="tabs" style="height: auto; border: none; padding: 0;">
                                                    <div id="companyInformation" style="<%= "companyInfo".equals(request.getParameter("tab")) ? "display:block" : "display:none" %>">
                                                               <div id="content1" class="tabPage">
                                                            <form id="companyInformationId">
                                                              <table class="table-notifications" width="80%" cellspacing="10" cellpadding="5" style="border-collapse: collapse; font-family: Arial, sans-serif;">
                                                                <!-- Company Information -->
                                                                <tr>
                                                                  <th colspan="2" style="background-color: #c9d0d4; text-align: left; padding: 8px;">Company Information</th>
                                                                </tr>

                                                                <tr>
                                                                  <td>Membership Level: <span style="color:red;">*</span></td>
                                                                  <td>
                                                                    <select name="membershipLevel" style="width:40%;">
                                                                      <option value="Standard (1 month free, after $9/month)">Standard (1 month free, after $9/month)</option>
                                                                      <option value="Professional (1 month free, after $9/month)">Professional (1 month free, after $9/month)</option>
                                                                      <option value="eSales (1 month free, after $49/month)">eSales (1 month free, after $49/month)</option>
                                                                    </select>
                                                                  </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td><input type="text" name="emailAddress" value="${companyInfo.emailAddress}" style="width:45%;"></td>
                                                                </tr>

                                                                <tr>
                                                                  <td>First Name: <span style="color:red;">*</span></td>
                                                                  <td><input type="text" name="firstName" value="${companyInfo.firstName}" style="width:45%;"></td>
                                                                </tr>

                                                                <tr>
                                                                  <td>Last Name: <span style="color:red;">*</span></td>
                                                                  <td><input type="text" name="lastName" value="${companyInfo.lastName}" style="width:45%;"></td>
                                                                </tr>

                                                                <tr>
                                                                  <td>Job Position: <span style="color:red;">*</span></td>
                                                                  <td>
                                                                    <select name="jobPosition" style="width:45%;">
                                                                ...
                                                                <!-- About Company -->
                                                                <tr>
                                                                  <th colspan="2" style="background-color: #c9d0d4; text-align: left; padding: 8px;">About Your Company</th>
                                                                </tr>

                                                                <tr>
                                                                  <td>Company Name: <span style="color:red;">*</span></td>
                                                                  <td><input type="text" name="companyName" value="${companyInfo.companyName}" style="width:45%;"></td>
                                                                </tr>

                                                                <tr>
                                                                  <td>DBA Name:</td>
                                                                  <td><input type="text" name="dbaName" value="${companyInfo.dbaName}" style="width:45%;"></td>
                                                                </tr>

                                                                <tr>
                                                                  <td>Business Type: <span style="color:red;">*</span></td>
                                                                  <td>
                                                                    <select name="businessType" style="width:45%;">
                                                                      <option selected>eSales</option>
                                                                ...
                                                                <tr>
                                                                  <td>Employer ID:</td>
                                                                  <td><input type="text" name="employerId" value="${companyInfo.employerId}" style="width:45%;" pattern="[0-9A-Za-z]{2}-[0-9A-Za-z]{7}" title="Format: XX-XXXXXXX" maxlength="10"></td>
                                                                </tr>

                                                                <tr>
                                                                  <td>Address 1: <span style="color:red;">*</span></td>
                                                                  <td><input type="text" name="address1" value="${companyInfo.address1}" style="width:45%;"></td>
                                                                </tr>

                                                                <tr>
                                                                  <td>Address 2:</td>
                                                                  <td><input type="text" name="address2" value="${companyInfo.address2}" style="width:45%;"></td>
                                                                </tr>

                                                                <tr>
                                                                  <td>Zip Code: <span style="color:red;">*</span></td>
                                                                  <td><input type="text" name="zipCode" value="${companyInfo.zipCode}" style="width:45%;"></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td>
                                                                 <input type="text" id="phone" name="phone" value="(555) 555-5555" style="width:45%;">
                                                                </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                  <td>Mobile Number:</td>
                                                                  <td>
                                                                     <input type="text" id="mobileNumber" name="mobileNumber" value="(555) 555-5555" style="width:45%;">
                                                                    <label>
                                                                            <input type="checkbox" id="sameAsPhone" checked> Same as the Phone Number
                                                                          </label>
                                                                  </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                  <td>Fax:</td>
                                                                  <td><input type="text" name="fax" value="gg" style="width:45%;"></td>
                                                                </tr>
                                                     ...
                                                     <div id="datamanager" style="<%= "datamanager".equals(request.getParameter("tab")) || request.getParameter("tab")==null ? "display:block" : "display:none" %>">
                                                          <div id="content1" class="tabPage">
                                                                  ...
                                                                  <div style="border: 1px solid #ccc; margin: 0 10px 10px 0; padding:15px 8px 0 8px; overflow-x:auto;">
                                                                      <table style="width:100%; border-collapse:collapse; table-layout:fixed;">
                                                                          ...
                                                                          <tr>
                                                                              ...
                                                                              <td colspan="5" valign="bottom" align="center" style="padding-top:20px; padding-right: 250px; padding-bottom: 0;">
                                                                                  ...
                                                                                  <div style="background:#fff; padding:0; text-align:center; width: 100%;">
                                                                                      ...
                                                                                      <div style="margin-top: 0px; padding-bottom: 1px; line-height: 0;">
                                                                                          ...
                                                                                          <input type="button" class="formbutton" onclick="dmDelete(); return false;" style="font-size:15px; padding:14px 14px; margin:0 2px 0 2px; background-color:#05A9C5; color:white; border:none; border-radius:3px 3px 0 0; cursor:pointer;" value="Delete" />
                                                                                      ...
                                                                                      <input type="hidden" id="dm-selected-category" value="" />
                                                                                                          ...
                                                                                                          <div id="Membership" style="<%= "membership".equals(request.getParameter("tab")) ? "display:block" : "display:none" %>">
...
var DM_CATEGORIES = [
    ...
    'message', 'payroll-deduction', 'description'
];
