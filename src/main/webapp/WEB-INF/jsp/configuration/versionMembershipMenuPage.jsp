		...
		<tr id="tr01">
			<td>
                ...
                <c:when test="${sessionScope.configActiveTab=='versionTab'}">
                    <a href="${pageContext.request.contextPath}/Configuration?tabid=configVersionMembership&&tab=tr01">
		  ...
		  <tr id="tr23">
            <td>
                ...
                <c:when test="${sessionScope.configActiveTab=='membershipTab'}">
                    <a href="${pageContext.request.contextPath}/Configuration?tabid=VMmembership&tab=tr23">
