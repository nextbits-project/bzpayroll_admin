...
<!-- Job Type Start -->
<form action="/settings/employee/update-employee-status" method="post">
                                                                                     ...
                                                                                     <div class="form-layout">
                                                                                       <table class="table table-bordered" style="font-size: 12px;">
                                                                                         <tr>
                                                                                           ...
                                                                                           <td colspan="3"><input type="text" class="form-control" name="employeeType" placeholder="Enter here" value="${bcpEmployeetype.employeeType}"  required /></td>
                                                                                           <td colspan="2"><input type="hidden" name="employeeTypeId" value="${bcpEmployeetype.employeeTypeId}" /></td>
