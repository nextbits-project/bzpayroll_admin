...
<div id="table-negotiations" style="width: 180px;padding: 0; overflow-x:auto;max-height: 850px; position: relative;">
	<table class="tabla-listados" cellspacing="0" style="border: 0; margin: 0;">
		...
		<tr id="tr01">
			<td>
				<c:choose>
                <c:when test="${sessionScope.configActiveTab=='versionTab'}">
                    <a href="${pageContext.request.contextPath}/Configuration?tabid=configVersion&&tab=tr01">
                        <img id="img0" src='ConfigurationImages/versionActive.png' />
                    </a>
                </c:when>
                <c:otherwise>
                    <a href="${pageContext.request.contextPath}/Configuration?tabid=configVersion&&tab=tr01">
                        <img id="img0" src='ConfigurationImages/version.png' />
                    </a>
                </c:otherwise>
                </c:choose>
			</td>
		...
		<tr id="tr40">
			<td>
				 <c:choose>
                 <c:when test="${sessionScope.configActiveTab=='posDesignFeaturesTab'}">
                     <a href="${pageContext.request.contextPath}/DesignFeaturesPOS?tabid=config40&&tab=tr40">
                         <img id="img40" src='ConfigurationImages/activePOS.png' />
                     </a>
                 </c:when>
                 <c:otherwise>
                     <a href="${pageContext.request.contextPath}/DesignFeaturesPOS?tabid=config40&&tab=tr40">
		...
		<tr id="tr9">
			...
			<td>
				<c:choose>
                <c:when test="${sessionScope.configActiveTab=='invoiceContractorCustomizationTab'}">
                    <a href="${pageContext.request.contextPath}/Configuration?tabid=config51&&tab=tr51">
                        <img id="img18" src='ConfigurationImages/contractor-active.jpg' width="150px"/>
                    </a>
                </c:when>
                <c:otherwise>
                    <a href="${pageContext.request.contextPath}/Configuration?tabid=config51&&tab=tr51">
                        <img id="img17" src='ConfigurationImages/contractor.jpg' width="150px" />
                    </a>
                </c:otherwise>
                </c:choose>
			</td>
		...
		<tr id="tr22">
          ...
          <td>
                          <c:choose>
                          <c:when test="${sessionScope.configActiveTab=='employeeTab'}">
                              <a href="${pageContext.request.contextPath}/Configuration?tabid=config001">
                                  <img id="img0040" src='ConfigurationImages/employee-2.png' />
                              </a>
                          </c:when>
                          <c:otherwise>
                              <a href="${pageContext.request.contextPath}/Configuration?tabid=config001">
                                  <img id="img0039" src='ConfigurationImages/employee2.png' />
                              </a>
                          </c:otherwise>
                          </c:choose>
                      </td>
