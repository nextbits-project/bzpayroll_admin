            ...
            <tr>
                <td colspan="3">
                    <table style="width:70%;">
                        <tr>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.orderimport.requisitioner" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.orderimport.shippingmethod" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.orderimport.paymentTerm" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.orderimport.dateRequired" /></th>
                        </tr>
                        <tr>
