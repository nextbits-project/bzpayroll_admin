...
.thColor { background: #A9A9A9; color: #FFF; }
...
<div>
    ...
    <table style="width:100%;" cellspacing="0">
        <tbody>
            ...
            <tr>
                <th class="tdBorder alignLeft thColor"><spring:message code="BzComposer.Invoice.BillTo" /></th>
                <th>&nbsp;</th>
                <th class="tdBorder alignLeft thColor"><spring:message code="BzComposer.Invoice.ShipTo" /></th>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                    <table style="width:100%;">
                        <tr>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.Invoice.PayMethod" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.Invoice.Rep" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.Invoice.ShipDateLower" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.Invoice.Via" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.common.noOfBoxes" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.Invoice.Term" /></th>
                        </tr>
                        <tr>
            ...
            <tr>
                <td colspan="3">
                    <table style="width:100%;">
                        <tr>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.Item.ItemCode" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.Item.ItemTitle" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.Invoice.Qty" /></th>
                            <th class="tdBorder thColor"><spring:message code="SalesTaxList.Rate" /></th>
                            <th class="tdBorder thColor"><spring:message code="BzComposer.Invoice.Amt" /></th>
                        </tr>
