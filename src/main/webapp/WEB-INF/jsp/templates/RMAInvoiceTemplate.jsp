...
<head>
    ...
    <title>
        <spring:message code="BzComposer.RMA.PrintRMATitle" />
    </title>
...
<body>
    ...
    <div id="cos">
        <div style="width: 100%;padding: 10px 30px 0px 0px;text-align: right;">
            ...
            <button type="button" class="formbutton" onclick="printInvoice();"
                style="padding: 5px 20px 5px 20px; font-size: 16px;">
        ...
        <div id="invoiceContentDiv" class="statusquo ok okDiv">
            <div>
                <c:if test="${empty PrintOrderDetails}">
                    <span style="width:100%;text-align: right;color:red;"><strong>
                            <spring:message code="BzComposer.employee.norecordsfound" />
                        </strong></span>
                </c:if>
                        ...
                        <tbody>
                            <tr>
                                <td style="width:45%;">
                                    <div style="float:left">
                                        <img
                                            src="${pageContext.request.contextPath}/images/new/NextBitsLogo.jpg" />
                                    </div>
                                    <div>
                                ...
                                <td style="width:45%;" align="right" valign="bottom">
                                    <table style="width:60%;">
                                        <tr>
                                            <td>
                                                <spring:message code="BzComposer.accounting.Date" />
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <spring:message
                                                    code="BzComposer.accountreceivable.ordernumber" />
                                            </td>
                                            <th>${PrintOrderDetails.order}</th>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="tdBorder alignLeft tdBorderBottom" valign="top">
                                    <span>
                                        <c:out value="${PrintOrderDetails.billTo}" escapeXml="false"/>
                                    </span>
                                </td>
                                <td>&nbsp;</td>
                                <td class=" tdBorder alignLeft" valign="top">
                                    <span>
                                        ${PrintOrderDetails.shipTo}
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <table style="width:100%;">
                                        <tr>
                                            ...
                                            <th class="tdBorder">
                                                <spring:message code="BzComposer.RMA.RmaDetail.Qty" />
                                            </th>
                                            <th class="tdBorder">
                                               
                                               <spring:message code="BzComposer.RMA.RmaDetail.Exchange_Refund" />
                                            </th>
                                            <th class="tdBorder">
                                                <spring:message code="BzComposer.purchaseorder.memo" />
                                            </th>
                                        </tr>
                                        <c:forEach items="${PrintOrderDetails.rmaItems}" var="cart"
                                            varStatus="loop">
                                            <tr id='${loop.index}row'>
                                                <td class="tdBorder">${cart.itemCode}</td>
                                                <td class="tdBorder">${cart.itemDesc}</td>
                                                <td class="tdBorder">${cart.qty}</td>
                                                <td class="tdBorder">${cart.exchangeRefund}</td>
                                                <td class="tdBorder">${cart.memo}</td>
                                            </tr>
                                        </c:forEach>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table style="width:95%;margin-top:5px;" align="right">
                                        <tr>
                                            <td>
                                                <spring:message
                                                    code="eSalesRefundReportDetails.Total" />
                                            </td>
                                            <td class="tdBorder alignRight">${PrintOrderDetails.total}
                                            </td>
                                        </tr>
                                    </table>
                                </td>
