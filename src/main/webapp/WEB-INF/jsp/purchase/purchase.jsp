...
<title><spring:message code="BzComposer.purchaseordertitle" />
</title>
<style type="text/css">
		...
		<div class="statusquo ok">
			<div id="hoja">
									...
									<tr>
										...
										<td>
											<div style="padding-top: 38px;text-align: center;">
												<c:if test="${purchaseOrderDto.invoiceStatus == 1}">
													<span style=" font-size: 30px; color: red !important; ">Canceled</span>
												</c:if>
												<c:if test="${purchaseOrderDto.invoiceStatus == 2}">
				...
				<font size="3"><strong>
						...
						<div class="row">
							<div class="col-md-12" style="font-size: 16px;" align="center">
								...
								<input type="button" class="formbutton"
									onclick="confirmAddressChange(this.form);" title="Save PurchaseOrder"
					...
					<input type="hidden" id="invoiceStatus" value="${purchaseOrderDto.invoiceStatus}"/>
					</form:form>
					<!-- end Contents -->
				</div>
				<div>
...
function clearItemData() {
   // Clear form fields
    ...
    // Remove all dynamically added rows (those with id="tr<number>")
    ...
    // Reset hidden value and index counter
    ...
    // Optionally, reset subtotal and other totals
        ...
        buttons: {
            "<spring:message code='BzComposer.global.ok'/>": function () {
				...
				$.ajax({
					...
					data: {type:"PurchaseBoard", orderNo: orderNo},
