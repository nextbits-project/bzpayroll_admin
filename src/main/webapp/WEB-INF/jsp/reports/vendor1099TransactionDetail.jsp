...
<title>${sessionScope.user}-<spring:message code="BzComposer.Report.Vendor1099TransactionDetail"/></title>
<style>
...
<body>
<form:form action="PurchaseBoard?tabid=vendor1099TransactionDetail" method="post" modelAttribute="purchaseBoardDto">
...
<div id="printContent">	
	...
	<div id="headerBar">
        ...
        <h6 style="text-align: center; color: blue;"
            id="headerBarValue">
            <spring:message code="BzComposer.Report.Vendor1099TransactionDetail" />
        </h6>
    </div>
...
function search()
{
	document.forms[0].action = "PurchaseBoard?tabid=vendor1099TransactionDetail";
