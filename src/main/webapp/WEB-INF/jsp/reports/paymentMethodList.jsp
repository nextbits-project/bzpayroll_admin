...
<title>${sessionScope.user} - <spring:message code="BzComposer.Report.Lists.PaymentMethod"/></title>
<style>
...
<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.Report.Lists.PaymentMethod"/></h6>
	</div>
	...
	<div id="table-negotiations" style="overflow:auto;height:500; text-align: center;">
		<table class="tabla-customListOds" cellspacing="0" id="exportPd" border="1">
			<thead>
				<tr>
						<th><spring:message code="PaymentTypeList.Payment_Type" /></th>
						<th><spring:message code="PaymentTypeList.Name" /></th>
				</tr>
			</thead>
			...
			<tbody>
                ...
                <tr>
                    <td>${curObject.paymentType}</td>
                    <td>${curObject.paymentName}</td>
                </tr>
                </c:forEach>
