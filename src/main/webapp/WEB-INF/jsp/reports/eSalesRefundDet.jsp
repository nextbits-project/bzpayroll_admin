...
<title>${sessionScope.user} - <spring:message code="ReportCenter.eSales_Refund_Detail"/></title>
<style>
...
<body>
<form:form action="ReportCenterESales?tabid=ESalesRefundDetail" method="post" modelAttribute="accountDto">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="ReportCenter.eSales_Refund_Detail"/></h6>
	</div>
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<thead>
			<tr>
                <th><spring:message code="eSalesRefundReportDetails.Client/Vendor" /></th>
                <th><spring:message code="eSalesRefundReportDetails.Order_No." /></th>
                <th><spring:message code="eSalesRefundReportDetails.Date" /></th>
                <th><spring:message code="eSalesRefundReportDetails.Item_Name" /></th>
                <th><spring:message code="eSalesRefundReportDetails.Quantity" /></th>
			</tr>
		</thead>
		<tbody>
...
function search()
{
	document.forms[0].action = "ReportCenterESales?tabid=ESalesRefundDetail";
