...
<title>${sessionScope.user} - <spring:message code="BzComposer.DailyItem.Summary"/></title>
<style>
...
<form:form action="Item?tabid=showReturnedInventoryList" method="post" modelAttribute="itemDto">
	...
	<div id="headerBar">
          ...
          <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.DailyItem.Summary"/></h6>
    </div>
	<table align="center">
		<tr>
