...
<title>${sessionScope.user}-<spring:message code="BzComposer.Report.vendor.BalanceSummary"/></title>
<style>
table.tabla-customListOds { width: 50%; border: 1px solid rgb(207, 207, 207); margin:auto; }
...
<body>
<form:form action="PurchaseBoard?tabid=VendorBalancesymmary" method="post" modelAttribute="purchaseBoardDto">
...
<div id="printContent">	
	...
	<div id="headerBar">
        ...
        <h6 style="text-align: center; color: blue;" id="headerBarValue">
            <spring:message code="BzComposer.Report.vendor.BalanceSummary" />
        </h6>
    </div>
	...
	<table class="tabla-customListOds" id="exportPd" border="1">
		<thead>
			<tr>
				<th><spring:message code="BzComposer.sales.Name" /></th>
...
function search()
{
	document.forms[0].action = "PurchaseBoard?tabid=VendorBalancesymmary";
