...
<title>${sessionScope.user}-<spring:message code="BzComposer.vendorphonelisttitle"/></title>
<style>
...
<body>
<form:form action="PurchaseBoard?tabid=VendorPhoneList" method="post" modelAttribute="purchaseBoardDto">
...
function search()
{
	document.forms[0].action = "PurchaseBoard?tabid=VendorPhoneList";
