...
<title>${sessionScope.user} - <spring:message code="BzComposer.Report.Lists.Ship"/></title>
<style>
...
<div id="headerBar">
      ...
      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.Report.Lists.Ship"/></h6>
</div>
<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
    <table class="tabla-customListOds" cellspacing="0" id="exportPd" border="1">
        <thead>
            <tr>
                <th><spring:message code="ShipVIAList.Term_Name" /></th>
            </tr>
        </thead>
        <tbody>
            <c:forEach items="${acList}" var="curObject">
            <tr>
                <td>${curObject.shipVia}</td>
            </tr>
            </c:forEach>
