...
<title>${sessionScope.user} - <spring:message code="BzComposer.Report.CustomerContactList"/></title>
<style>
...
<body>
<form:form action="Customer?tabid=CustomerContactList" method="post" modelAttribute="customerDto">
	...
	<div id="ddcolortabsline">&nbsp;</div>
		...
		<spring:message code="BzComposer.Report.CustomerContactList" /></span> --%>
		...
		<div id="printContent">
			...
			<div id="table-negotiations"
				...
				<table id="exportPd" class="tabla-customListOds" border="1">
					...
					<thead>
						<tr>
							<th class="emblem"><spring:message code="BzComposer.configuration.tab.customer" /></th>
							<th><spring:message code="BzCompoer.report.customercontract.fullname" /></th>
							<th><spring:message code="BzComposer.report.vendorcontactlist.billto" /></th>
					...
					<tbody>
							<c:if test="${not empty customerContactList}">
								<input type="hidden" name="sListSize" id="lSize" value='${customerContactList.size()}'>
								<c:forEach items="${customerContactList}" var="customer">
									<tr>
...
function search()
{
	document.forms[0].action = "Customer?tabid=CustomerContactList";
