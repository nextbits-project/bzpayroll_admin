...
<title>${sessionScope.user} - <spring:message code="BzComposer.Report.Returned.InventoryList"/></title>
<style>
...
<body>
<form:form action="Item?tabid=showReturnedInventoryList" method="post" modelAttribute="itemDto">
	...
	<div id="headerBar">
          ...
          <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.Report.Returned.InventoryList"/></h6>
    </div>
	<table align="center">
		<tr>
...
function search()
{
	document.forms[0].action = "Item?tabid=showReturnedInventoryList";
