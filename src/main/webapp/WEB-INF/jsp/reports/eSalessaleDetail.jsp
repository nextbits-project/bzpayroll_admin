...
<title>${sessionScope.user} - <spring:message code="ReportCenter.eSales_sale_Detail"/></title>
<style>
...
<body>
<form:form action="ReportCenterESales?tabid=ESalessaleDetail" method="post" modelAttribute="accountDto">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="ReportCenter.eSales_sale_Detail"/></h6>
	</div>
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<thead>
			<tr>
                <th><spring:message code="eSalesSalesReportDetails.Client/Vendor" /></th>
                <th><spring:message code="eSalesSalesReportDetails.Invoice_No." /></th>
                <th><spring:message code="eSalesSalesReportDetails.Date" /></th>
                <th><spring:message code="eSalesSalesReportDetails.Item_Name" /></th>
                <th><spring:message code="eSalesSalesReportDetails.Quantity" /></th>
			</tr>
		</thead>
		<tbody>
...
function search()
{
	document.forms[0].action = "ReportCenterESales?tabid=ESalessaleDetail";
