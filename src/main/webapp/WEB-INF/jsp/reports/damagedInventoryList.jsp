...
<title>${sessionScope.user} - <spring:message code="BzComposer.Report.Damaged.InventoryList"/></title>
<style>
...
<body>
<form:form action="Item?tabid=showDamagedInventoryList" method="post" modelAttribute="itemDto">
	...
	<div id="headerBar">
          ...
          <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.Report.Damaged.InventoryList"/></h6>
    </div>
	<table align="center">
		<tr>
