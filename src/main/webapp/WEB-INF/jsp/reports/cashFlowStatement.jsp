...
<title>${sessionScope.user} - <spring:message code="BzComposer.Report.Profit&Budget.CashFlowStatement"/></title>
<style>
...
<body>
<form:form action="ShowCashFlow?tabid=BalanceSheet" method="post" modelAttribute="accountDto">
...
<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.Report.Profit&Budget.CashFlowStatement"/></h6>
	</div>
	...
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		<table class="tabla-customListOds" cellspacing="0" id="exportPd" border="1">
			<thead>
				<tr>
                    <th><spring:message code="CashFlowStatement.Activity" /></th>
                    <th><spring:message code="CashFlowStatement.Amount" /></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td><spring:message code="CashFlowStatement.OPERATING_ACTIVITIES"/></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="CashFlowStatement.Net_Income"/></td>
					<td>${CashFlowStatement_NetIncome}</td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="CashFlowStatement.Adjust_To_Reconcile_Net_Income"/></td>
					<td></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="CashFlowStatement.To_Net_Provided_By_Operations"/></td>
					<td></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="CashFlowStatement.Accounts_Receivable"/></td>
					<td>${CashFlowStatement_ARBalance}</td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="CashFlowStatement.Accounts_Payable"/></td>
					<td>${CashFlowStatement_APBalance}</td>
				</tr>
				<tr>
					<td><spring:message code="CashFlowStatement.Net_Cash_Provided_By_Operating_Activities"/></td>
					<td>${CashFlowStatement_NetCashProvidedByOA}</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td><spring:message code="CashFlowStatement.FINANCING_ACTIVITIES"/></td>
					<td></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="CashFlowStatement.Opening_Balance_Equity"/></td>
					<td>${CashFlowStatement_OBE}</td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="CashFlowStatement.Net_Cash_Provided_By_Financing_Activities"/></td>
					<td>${CashFlowStatement_NetCashProvidedByFA}</td>
				</tr>
				<tr>
					<td><spring:message code="CashFlowStatement.Net_Cash_Increased_By_Period"/></td>
					<td>${CashFlowStatement_NetCashIncreasedByPeriod}</td>
				</tr>
				<tr>
					<td><spring:message code="CashFlowStatement.Cash_At_The_End_Of_Period"/></td>
					<td>${CashFlowStatement_CashAtTheEndOfPeriod}</td>
				</tr>
			<%-- <c:if test="${not empty acList}">
					<input type="hidden" name="sListSize" id="lSize" value='${catList}'>
				<c:forEach items="${acList}" var="objList">
                    <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${objList.accountName}</td>
