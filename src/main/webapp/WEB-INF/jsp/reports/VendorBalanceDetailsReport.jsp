...
<title>${sessionScope.user}-<spring:message code="BzComposer.vendorbalancedetailtitle"/></title>
<style>
...
<body>
<form:form action="PurchaseBoard?tabid=VendorBalancedetails" method="post" modelAttribute="purchaseBoardDto">
	...
	<div id="printContent">
		...
		<div id="headerBar">
            ...
            <h6 style="text-align: center; color: blue;" id="headerBarValue">
                <spring:message code="BzComposer.report.vendorbalancelist.vendorbalancedetailstitle" />
            </h6>
        </div>
		<div id="table-negotiations" style="overflow: auto; height: 400; text-align: center;">
			<table class="tabla-customListOds" id="exportPd" border="1">
				<thead>
					<tr>
						<th><spring:message code="BzComposer.report.vendorbalancelist.name" /></th>	
						<th><spring:message code="BzComposer.report.vendorbalancelist.podate" /></th>
						<th><spring:message code="BzComposer.report.vendorbalancelist.ponumber" /></th>	
					<%--<th><spring:message code="BzComposer.Report.vendor.BalanceSummary.Type" /></th>
						<th><spring:message code="BzComposer.Report.vendor.BalanceSummary.Account" /></th>--%>
						<th><spring:message code="BzComposer.report.vendorbalancelist.amount" /></th>
					<%--<th><spring:message code="BzComposer.Report.vendor.BalanceSummary.PaidAmount" /></th>--%>
				...
				<tbody>
				    <c:if test="${not empty PurchaseBoardDetails}">
                        ...
                        <c:forEach items="${PurchaseBoardDetails}" var="curObject">
                            <tr>
                                <td>${curObject.firstName}(${curObject.companyName})</td>
...
function search()
{
	document.forms[0].action = "PurchaseBoard?tabid=VendorBalancedetails";
