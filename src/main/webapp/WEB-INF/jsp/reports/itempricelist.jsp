...
<title>${sessionScope.user} -<spring:message code="BzComposer.itempricelist" /></title>
<style>
...
<div id="ddcolortabsline">&nbsp;</div>
	<div class="clear"></div>
		<form:form action="Item?tabid=ItemPriceList" method="post" modelAttribute="itemDto">
			...
			<div id="table-negotiations" style="overflow: auto; height: 400; text-align: center;">
				<table class="tabla-customListOds" id="exportPd" border="1">
					<thead>
						<tr>
							<th class="emblem">
								<spring:message code="BzComposer.report.itempricelist.item" />
							</th>
							<th class="emblem">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<%--<th class="emblem">
								<spring:message code="BzComposer.Report.ReservedInventoryList.ItemPriceList.descriptiontitle" />
							</th> --%>
							<th class="emblem">
								<spring:message code="BzComposer.report.itempricelist.purchaseprice" />
							</th>
							<th class="emblem">
								<spring:message code="BzComposer.report.itempricelist.saleprice" />
							</th>
						</tr>
					</thead>
					<tbody>
						<c:if test="${not empty ItemDetails}">
                            ...
                            <c:forEach items="${ItemDetails}" var="item">
                                <tr>
                                    <td>${item.itemName}</td>
                                    <td></td>
                                <%-- <td>&nbsp;${item.inventoryDes}</td> --%>
                                    <td>&nbsp;${item.purchasePrice}</td></td>
                                    <td>&nbsp;${item.salePrice}</td></td>
                                </tr>
                            </c:forEach>
						</c:if>
					</tbody>
...
function search()
{
	document.forms[0].action = "Item?tabid=ItemPriceList";
