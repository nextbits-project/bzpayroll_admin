...
<body>
<form:form action="Customer?tabid=CustomerList" method="post" modelAttribute="customerDto">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.reportcenter.listing.customerlist"/></h6>
	</div>
	<div id="table-negotiations" style="overflow:auto;height:500; text-align: center;">
		...
		<thead>
			<tr>
				<th><spring:message code="BzComposer.Vendor.CompanyName" /></th>
                ...
                <th style="padding-right:50px;"><spring:message code="BzComposer.global.address1" /></th>
                ...
                <th><spring:message code="BzComposer.reportcenter.tax.salestax.detail"/></th>
			</tr>
		</thead>
		<tbody>
...
function search()
{
	document.forms[0].action = "Customer?tabid=CustomerList";
