...
<title>${sessionScope.user} - <spring:message code="BzComposer.Report.Lists.SaleRepList"/></title>
<style>
...
<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.Report.Lists.SaleRepList"/></h6>
	</div>
	...
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<table class="tabla-customListOds" cellspacing="0" id="exportPd" border="1">
			...
			<thead>
				<tr>
					<th><spring:message code="SalesRepList.Sales_Representative_Name" /></th>
				</tr>
			</thead>
