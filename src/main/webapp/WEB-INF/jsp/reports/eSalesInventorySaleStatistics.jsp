...
<title>${sessionScope.user} - <spring:message code="ReportCenter.eSales_Inventory_Sale_Statistics"/></title>
<style>
...
<body>
<form:form action="ReportCenterESales?tabid=ESalesInventorySaleStatistics" method="post" modelAttribute="accountDto">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="ReportCenter.eSales_Inventory_Sale_Statistics"/></h6>
	</div>
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<thead>
			<tr>
                <th><spring:message code="eSalesInvoiceDetails.Store_Type" /></th>
                <th><spring:message code="eSalesInvoiceDetails.Store_Name" /></th>
                <th><spring:message code="eSalesInvoiceDetails.Inventory_Name" /></th>
                <th><spring:message code="eSalesInvoiceDetails.Date" /></th>
                <th><spring:message code="eSalesInvoiceDetails.Qty" /></th>
			</tr>
		</thead>
		<tbody>
...
function search()
{
	document.forms[0].action = "ReportCenterESales?tabid=ESalesInventorySaleStatistics";
