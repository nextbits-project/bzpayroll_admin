...
<title>${sessionScope.user}-<spring:message code="BzComposer.Report.PurchaseBills"/></title>
<style>
...
<body>
<form:form action="PurchaseBoard?tabid=AllPurchaseBillList" method="post" modelAttribute="purchaseBoardDto">
...
<div id="printContent">	
    ...
    <div id="headerBar">
        ...
        <h6 style="text-align: center; color: blue;"
            id="headerBarValue">
            <spring:message code="BzComposer.Report.PurchaseBills" />
        </h6>
    </div>
	...
	<table class="tabla-customListOds" id="exportPd" border="1">
		...
		<thead>
			<tr>
					...
					<th ><spring:message code="BzComposer.Employee.Amount" /></th>
...
function search()
{
	document.forms[0].action = "PurchaseBoard?tabid=AllPurchaseBillList";
