...
<title>${sessionScope.user}-<spring:message code="BzComposer.Report.Vendor1099TransactionSummary"/></title>
<style>
...
<body>
<form:form action="PurchaseBoard?tabid=vendor1099TransactionSummary" method="post" modelAttribute="purchaseBoardDto">
...
<div id="printContent">	
	...
	<div id="headerBar">
        ...
        <h6 style="text-align: center; color: blue;"
            id="headerBarValue">
            <spring:message code="BzComposer.Report.Vendor1099TransactionSummary" />
        </h6>
    </div>
	...
	<table class="tabla-customListOds" id="exportPd" border="1">
		<thead>
			<tr>
                <th ><spring:message code="BzComposer.vendor.vendors" /></th>
                <th><spring:message code="BzComposer.Vendor.Company" /></th>
                <th ><spring:message code="BzComposer.Customer.Phone" /></th>
                <th ><spring:message code="BzComposer.Email.Email" /></th>
            </tr>
		</thead>
		<tbody>
		    <c:if test="${not empty vendorList1099}">
                <input type="hidden" name="sListSize" id="lSize" value='${vendorList1099.size()}'>
                <c:forEach items="vendorList1099" var="vendor">
                    <tr>
                        <td>${vendor.cvName}</td>
                ...
                <tr><td><b><spring:message code="BzComposer.Invoice.Total" /></b></td>
                    <td><b>${total}</b></td>
                </tr>
            </c:if>
		</tbody>
...
function search()
{
	document.forms[0].action = "PurchaseBoard?tabid=vendor1099TransactionSummary";
