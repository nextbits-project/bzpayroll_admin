...
<title>${sessionScope.user} - <spring:message code="BzComposer.Report.Profit&Budget.IncomeStatement"/></title>
<style>
...
table.tabla-customListOds tbody tr td { font-size: 14px; border: 1px solid #D3D3D3; }
</style>
</head>
<body>
<form:form action="Category?tabid=IncomeStatement" method="post" modelAttribute="categoryListDto">
	...
	<div class="report-form-underheader">
	 <table>
	    	<tr>
	    		...
	    		<td><img src="images/cal.gif" onclick="displayCalendar(document.CategoryListForm.fromDate,'mm-dd-yyyy',this);" style="padding-left: 5px"></td>
	    		<td><label style="padding-left: 15px"><spring:message code="BzComposer.sales.to"/></label></td>
	    		<td><form:input path="toDate" size="15"/></td>
	    		<td><img src="images/cal.gif" onclick="displayCalendar(document.CategoryListForm.toDate,'mm-dd-yyyy',this);" style="padding-left: 5px"></td>
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.Report.Profit&Budget.IncomeStatement"/></h6>
	</div>
	<div id="table-negotiations" style="overflow:auto;height:500; text-align: center;">
		...
		<tbody>
		<tr>
			<td style="padding-left: 5px;color: blue;"><spring:message code="BzComposer.Report.Customer.Income"/></td>
			<td></td>
		</tr>	
		<tr>
			<td><spring:message code="BzComposer.Report.GrossSales"/></td>
			<td><b>${totalGrossIncome}</b></td>
		</tr>	
		<tr>
			<td style="padding-left: 55px;color: blue;padding-top: 15px"><spring:message code="BzComposer.Report.GrossIncome"/></td>
			<td style="color: blue;padding-top: 15px"><b><u>${totalGrossIncome}</u></b></td>
		</tr>
		<%-- <tr>
...
<%-- 			<input type="hidden" name="sListSize" id="lSize" value='${catList.size()}'> --%>
 				<c:forEach items="${catList}" var="curObject">
                    <tr>
                    <td>${curObject.name}</td>
                    <td>${curObject.amount}</td>
                    </tr>
                </c:forEach>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><spring:message code="BzComposer.Report.TotalOperating"/></b></td>
                    <td><ul>.00</ul></td>
                </tr>
                <tr>
                    <td style="padding-top: 15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><spring:message code="BzComposer.Report.NetOperatingIncome"/></b></td>
                    <td style="padding-top: 15px;"><b>${netIncome}</b></td>
                </tr>
                <tr>
                    <td style="color: blue;padding-left: 5px;padding-top: 15px;"><b><u><spring:message code="BzComposer.Report.NetIncomeLoss"/></u></b></td>
                    <td style="color: blue;padding-top: 15px;"><b><u>${netIncome}</u></b></td>
                </tr>
			</c:if>
		</tbody>
	</table>
