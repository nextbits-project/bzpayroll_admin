...
<title>${sessionScope.user} - <spring:message code="ReportCenter.eSales_Invoice_Detail"/></title>
<style>
...
<body>
<form:form action="ReportCenterESales?tabid=ESalesInvoiceDetail" method="post" modelAttribute="accountDto">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="ReportCenter.eSales_Invoice_Detail"/></h6>
	</div>
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<thead>
			<tr>
                <th><spring:message code="eSalesInvoiceDetails.Order_No." /></th>
                <th><spring:message code="eSalesInvoiceDetails.Date" /></th>
                <th><spring:message code="eSalesInvoiceDetails.Client/Vendor" /></th>
                <th><spring:message code="eSalesInvoiceDetails.Amount" /></th>
                <th><spring:message code="eSalesInvoiceDetails.Balance" /></th>
			</tr>
		</thead>
		<tbody>
...
function search()
{
	document.forms[0].action = "ReportCenterESales?tabid=ESalesInvoiceDetail";
