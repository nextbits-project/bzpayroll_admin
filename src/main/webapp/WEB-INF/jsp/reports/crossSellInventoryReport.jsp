...
<title>${sessionScope.user} - <spring:message code="cross_Sell_Inventory_Report"/></title>
<style>
	    	...
	    	<tr>
	    		...
	    		<td>
	    		  <form:select path="datesCombo">
	    		  	<form:option value="0" ><spring:message code="BzComposer.reportcenter.allinvoicelist.dates.all"/></form:option>
	    		  	<form:option value="1"><spring:message code="BzComposer.reportcenter.allinvoicelist.dates.today"/></form:option>
	    		  	<form:option value="2"><spring:message code="BzComposer.reportcenter.allinvoicelist.dates.thisweek"/></form:option>
	    		  	<form:option value="3"><spring:message code="BzComposer.reportcenter.allinvoicelist.dates.thisweektodate"/></form:option>
	    		  	<form:option value="4"><spring:message code="BzComposer.reportcenter.allinvoicelist.dates.thismonth"/></form:option>
	    		  	<form:option value="5"><spring:message code="BzComposer.reportcenter.allinvoicelist.dates.thismonthtodate"/></form:option>
	    		  	<form:option value="6"><spring:message code="BzComposer.reportcenter.allinvoicelist.dates.fiscalquarter"/></form:option>
	    		  	<form:option value="7"><spring:message code="BzComposer.reportcenter.allinvoicelist.dates.fiscalquartertodate"/></form:option>
	    		  	<form:option value="8">
	    		...
	    		<td><label style="padding-left: 15px"><spring:message code="BzComposer.reportcenter.allinvoicelist.from"/></label></td>
	    		...
	    		<td><label style="padding-left: 15px"><spring:message code="BzComposer.reportcenter.allinvoicelist.to"/></label></td>
	    		...
	    		<td><label style="padding-right: 10px;padding-left: 15px"><spring:message code="BzComposer.reportcenter.allinvoicelist.sortby"/></label></td>
	    		<td>
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="cross_Sell_Inventory_Report"/></h6>
	</div>
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<thead>
			<tr>
                ...
                <th><spring:message code="BzComposer.report.discountinuedinventorylist.sku" /></th>
                <th><spring:message code="crossSellDetails.OnHandQTY" /></th>
                <th><spring:message code="BzComposer.report.inventorylist.purchaseprice" /></th>
                <th><spring:message code="BzComposer.report.inventorylist.saleprice" /></th>
			</tr>
		</thead>
		<tbody>
