...
<title>${sessionScope.user}-<spring:message code="BzComposer.Report.Vendor1099Title"/></title>
<style>
...
<body>
<form:form action="PurchaseBoard?tabid=Vendor1099List" method="post" modelAttribute="purchaseBoardDto">
...
<div id="printContent">
	...
	<div id="headerBar">
        ...
        <h6 style="text-align: center; color: blue;"
            id="headerBarValue">
            <spring:message code="BzComposer.Report.Vendor1099Title" />
        </h6>
    </div>
...
function search()
{
	document.forms[0].action = "PurchaseBoard?tabid=Vendor1099List";
