...
<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.Report.Lists.TermList"/></h6>
	</div>
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		<table class="tabla-customListOds" cellspacing="0" id="exportPd" border="1">
			<thead>
				<tr>
						<th><spring:message code="TermsList.Term_Name" /></th>
						<th><spring:message code="TermsList.Days" /></th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${acList}" var="curObject">
				<tr>
					<td>${curObject.termName}</td>
					<td>${curObject.days}</td>
				</tr>
				</c:forEach>
