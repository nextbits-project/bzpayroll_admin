...
<title>${sessionScope.user} - <spring:message code="BzComposer.SalesPanel.SalesReportByCustomer"/></title>
<style>
...
<body>
<form:form action="SalesBord?tabid=SalesRBC&ilist=1" method="post" modelAttribute="salesBoardDto">
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.SalesPanel.SalesReportByCustomer"/></h6>
	</div>
	<div id="table-negotiations" style="overflow:auto;height:500; text-align: center;">
		...
		<thead>
			<tr>
					<th><spring:message code="BzComposer.Customer.Company" /></th>
				<th><spring:message code="BzComposer.Employee.Name" /></th>
				<th><spring:message code="BzComposer.SalesPanel.SalesTitle" /></th>
				<th><spring:message code="BzComposer.Report.Employee.SalesReportByRep.RefundAmount" /></th>
				<th><spring:message code="BzComposer.SalesPanel.AdjSales" /></th>
			</tr>
		</thead>
...
function search()
{
	document.forms[0].action = "SalesBord?tabid=SalesRBC&ilist=1";
