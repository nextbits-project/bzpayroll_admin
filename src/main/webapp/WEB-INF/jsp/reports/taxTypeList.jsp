...
<title>${sessionScope.user} - <spring:message code="BzComposer.Report.Lists.Tax"/></title>
<style>
...
<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.Report.Lists.Tax"/></h6>
	</div>
	...
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<table class="tabla-customListOds" cellspacing="0" id="exportPd" border="1">
			...
			<thead>
				<tr>
                    <th><spring:message code="SalesTaxList.State" /></th>
                    <th><spring:message code="SalesTaxList.Rate" /></th>
				</tr>
			</thead>
			...
			<tbody>
				...
				<tr>
                    <td>${curObject.state}</td>
                    <td>${curObject.rate}</td>
				</tr>
				</c:forEach>
