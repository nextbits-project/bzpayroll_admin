...
<title>${sessionScope.user} - <spring:message code="BzComposer.DailySales.Summary"/></title>
<style>
...
<body>
<form:form action="Item?tabid=showDailySalesSummary" method="post" modelAttribute="itemDto">
	...
	<div id="headerBar">
          ...
          <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.DailySales.Summary"/></h6>
    </div>
	<table align="center">
		<tr>
...
function search()
{
	document.forms[0].action = "Item?tabid=showDailySalesSummary";
