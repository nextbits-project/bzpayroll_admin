...
<title>${sessionScope.user} - <spring:message code="BzComposer.paidinvoicelisttitle"/></title>
<style>
...
<body>
<form:form action="SalesBord?tabid=PaidInvoiceList&ilist=2" method="post" modelAttribute="salesBoardDto">
		...
		<div id="headerBar">
	    	<h5 style="text-align: center;color: blue;padding-top: 20px">${sessionScope.user}</h5>
	      	<h6 style="text-align: center;color: blue;" id="headerBarValue">
	      		<spring:message code="BzComposer.report.paidinvoicelist.paidinvoice"/>
      		</h6>
		</div>
...
function search()
{
	document.forms[0].action = "SalesBord?tabid=PaidInvoiceList&ilist=2";
