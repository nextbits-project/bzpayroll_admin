...
<title>${sessionScope.user} - <spring:message code="BzComposer.Report.CustomerBalanceDetail"/></title>
<style>
...
<body>
<form:form action="Customer?tabid=CustomerBalDetail" method="post" modelAttribute="customerDto">
	...
	<div class="report-form-underheader">
	 <table>
	    	<tr>
	    		...
	    		<td><img src="${pageContext.request.contextPath}/images/cal.gif" onclick="displayCalendar(document.CustomerForm.fromDate,'mm-dd-yyyy',this);" style="padding-left: 5px"></td>
	    		<td><label style="padding-left: 15px"><spring:message code="BzComposer.sales.to"/></label></td>
	    		<td><form:input path="toDate" size="15"/></td>
	    		<td><img src="${pageContext.request.contextPath}/images/cal.gif" onclick="displayCalendar(document.CustomerForm.toDate,'mm-dd-yyyy',this);" style="padding-left: 5px"></td>
...
<div id="printContent">	
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.Report.CustomerBalanceDetail"/></h6>
	</div>
	<div id="table-negotiations" style="overflow:auto;height:400; text-align: center;">
		...
		<thead>
			<tr>
			<th><spring:message code="BzComposer.Companyinformation.Customer" /></th>
			<th><spring:message code="BzComposer.Invoice.Date" /></th> 
			<th><spring:message code="BzComposer.Invoice.OrderNo" /></th> 
			<th><spring:message code="BzComposer.Invoice.Amt" /></th> 
			<th><spring:message code="BzComposer.Report.Purchaseorder.Balance" /></th> 
			</tr>
		</thead>

		<tbody>
			<c:if test="${not empty balanceDetail}">
<%-- 		<input type="hidden" name="sListSize" id="lSize" value='${balanceDetail.size()}'>  --%>
 			<c:forEach items="${balanceDetail}" var="customer">
                <tr>
...
function search()
{
	document.forms[0].action = "Customer?tabid=CustomerBalDetail";
