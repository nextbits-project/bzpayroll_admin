...
function ts_resortTable(lnk) {
	...
	if (itm.match(/^[a-zA-Z0-9 ]+$/)) sortfn = ts_sort_alpha_numeric;
...
function ts_sort_alpha_numeric(a, b) {
	...
	bb = ts_getInnerText(b.cells[SORT_COLUMN_INDEX]).toLowerCase();
	  ...
	  if (aA === bA) {
	    var aN = parseInt(aa.replace(reN, ""), 10);
	    var bN = parseInt(bb.replace(reN, ""), 10);
