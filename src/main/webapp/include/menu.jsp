                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="fileDropDown">
                                <li>
                                    <a class="dropdown-item" href="${pageContext.request.contextPath}/payroll-dashboard" style="cursor: pointer;">
                                        <span>
                        ...
                        <!-- Employee List -->
                        <!--  <li class="nav-item">
						<a class="nav-link" href="/employee-list" title="Employee">
							<spring:message code="BzComposer.EmployeeList" />
						</a>
					</li>       --!>

					 <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="employeeDropDown" role="button" data-toggle="dropdown" aria-expanded="false">
                                   <spring:message code="BzComposer.Employee" />
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="employeeDropDown">
                                   <!-- <li><a class="dropdown-item" href="/dashboard/employee/employeeRole">
                                    Employee Role</a>
                                    </li> --!>
                                     <li><a class="dropdown-item" href="/employee-board">
                                            Employee board</a>
                                     </li>
                                   <!--<li><a class="dropdown-item" href="/dashboard/employee/employeeboard">Employee Board1</a></li>-->



                        <li> <a class="dropdown-item" href="/employee-w2form">
                                W2 Form
                            </a></li>
                        <li> <a class="dropdown-item" href="/formw4">
                                W4 Form
                            </a></li>
                        <li><a class="dropdown-item" href="/employee-reviews">
                                Reviews</a>
                        </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="timesheetDropdown">
                            <a class="dropdown-item" href="/create-employee-timesheet">Employee Timesheet</a>
                            <a class="dropdown-item" href="/created-timesheet">Created Timesheet</a>
                        </div>
                    </li>
                   ...
                   <ul class="dropdown-menu">
                    ...
                    <!-- Settings Menu Trigger -->
                    <li class="nav-item" id="settingsTrigger">
                        <a class="nav-link" href="/settings/general" id="settingsToggle">SETTINGS</a>
                    </li>
                    <li class="nav-item menu-icon-divider-item" aria-hidden="true">
                        <span class="nav-link menu-icon-divider">
