    ...
    data.forEach(tax => {
        ...
        row.innerHTML = `
            ...
            <td class="col px-md-3">
                 ...
                 <button class="btn btn-sm btn-danger btn-delete-federal" style=" padding: 9px 12px; "  data-id="${tax.id}" data-bs-toggle="modal" data-bs-target="#deleteFederalTaxModal">
                    <i class="fa-regular fa-trash" style=" margin-inline-end: 0px; "></i>
                 </button>
             </td>
        `;
