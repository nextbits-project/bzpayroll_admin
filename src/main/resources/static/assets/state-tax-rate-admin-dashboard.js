...
const stateNameText = document.getElementById("state-name-text");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    stateNameText.innerText = selectedState;
    ...
    data.forEach(tax => {
        ...
        row.innerHTML = `
            ...
            <td>
                ...
                <button class="btn btn-sm btn-danger" style=" padding: 9px 12px; " data-id="${tax.id}" data-bs-toggle="modal" data-bs-target="#deleteTaxModal">
                    <i class="fa-regular fa-trash" style=" margin-inline-end: 0px; "></i>
                 </button>
            </td>
        `;
