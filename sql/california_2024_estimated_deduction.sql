...
-- TABLE 2 - ESTIMATED DEDUCTION TABLE (2024 California Withholding Schedules Method B)
...
VALUES
    (0,     4.00,     4.00,     4.00,     4.00, 'California', 2024),
    (1,    19.00,    19.00,    19.00,    19.00, 'California', 2024),
    (2,    38.00,    38.00,    38.00,    38.00, 'California', 2024),
    (3,    42.00,    42.00,    42.00,    42.00, 'California', 2024),
    (4,    83.00,    83.00,    83.00,    83.00, 'California', 2024),
    (5,   250.00,   250.00,   250.00,   250.00, 'California', 2024),
    (6,  1000.00,  1000.00,  1000.00,  1000.00, 'California', 2024),
    (7,   500.00,   500.00,   500.00,   500.00, 'California', 2024);
